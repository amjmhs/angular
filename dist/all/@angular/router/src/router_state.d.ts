 ...
 * @internal
 */
export declare function inheritedParamsDataResolve(route: ActivatedRouteSnapshot, paramsInheritanceStrategy?: ParamsInheritanceStrategy): Inherited;
/**
 * @description
 *
 * Contains the information about a route associated with a component loaded in an
...
export declare class ActivatedRouteSnapshot {
    ...
    outlet: string, 
    /** The component of the route */
    component: Type<any> | string | null, routeConfig: Route | null, urlSegment: UrlSegmentGroup, lastPathIndex: number, resolve: ResolveData);
    /** The root of the router state */
