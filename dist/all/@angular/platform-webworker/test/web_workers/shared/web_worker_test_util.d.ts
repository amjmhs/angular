...
import { ClientMessageBroker, ClientMessageBrokerFactory } from '@angular/platform-webworker/src/web_workers/shared/client_message_broker';
...
export declare const _ClientMessageBrokerFactory: {
    new (a: any, b: any): ClientMessageBrokerFactory;
};
export declare class MockMessageBrokerFactory extends _ClientMessageBrokerFactory {
