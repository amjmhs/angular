...
class IvyCompilation {
     ...
     * `null` in most cases.
     */
    constructor(handlers, checker, reflector, coreImportsFrom) {
    ...
    compileIvyFieldFor(node) {
        ...
        let res = op.adapter.compile(node, op.analysis);
     ...
     */
    transformedDtsFor(tsFileName, dtsOriginalSource, dtsPath) {
