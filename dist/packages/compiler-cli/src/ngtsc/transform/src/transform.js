...
class IvyVisitor extends visitor_1.Visitor {
    constructor(compilation, reflector, importManager, isCore) {
        super();
...
function transformIvySourceFile(compilation, context, reflector, coreImportsFrom, file) {
    ...
    const sf = visitor_1.visit(file, new IvyVisitor(compilation, reflector, importManager, coreImportsFrom !== null), context);
