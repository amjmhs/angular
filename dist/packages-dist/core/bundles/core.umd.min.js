 ...
 */function defineInjectable(opts){return{providedIn:opts.providedIn||null,factory:opts.factory,value:void 0}}function defineInjector(options){return{factory:options.factory,providers:options.providers||[],imports:options.imports||[]}}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
var Directive=makeDecorator("Directive",function(dir){return void 0===dir&&(dir={}),dir},void 0,void 0,function(type,meta){}),Component=makeDecorator("Component",function(c){return void 0===c&&(c={}),__assign({changeDetection:ChangeDetectionStrategy.Default},c)},Directive,void 0,function(type,meta){}),Pipe=makeDecorator("Pipe",function(p){return __assign({pure:!0},p)},void 0,void 0,function(type,meta){}),Input=makePropDecorator("Input",function(bindingPropertyName){return{bindingPropertyName:bindingPropertyName}}),Output=makePropDecorator("Output",function(bindingPropertyName){return{bindingPropertyName:bindingPropertyName}}),HostBinding=makePropDecorator("HostBinding",function(hostPropertyName){return{hostPropertyName:hostPropertyName}}),HostListener=makePropDecorator("HostListener",function(eventName,args){return{eventName:eventName,args:args}}),Type=Function;function isType(v){return"function"==typeof v}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var NgModule=makeDecorator("NgModule",function(ngModule){return ngModule},void 0,void 0,function(type,meta){return moduleType=type,imports=(metadata=meta)&&metadata.imports||[],metadata&&metadata.exports&&(imports=imports.concat([metadata.exports])),void(moduleType.ngInjectorDef=defineInjector({factory:convertInjectableProviderToFactory(moduleType,{useClass:moduleType}),providers:metadata&&metadata.providers,imports:imports}));var moduleType,metadata,imports}),ViewEncapsulation={Emulated:0,Native:1,None:2,ShadowDom:3};
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */ViewEncapsulation[ViewEncapsulation.Emulated]="Emulated",ViewEncapsulation[ViewEncapsulation.Native]="Native",ViewEncapsulation[ViewEncapsulation.None]="None",ViewEncapsulation[ViewEncapsulation.ShadowDom]="ShadowDom";
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function getNullInjector(){return void 0===NULL_INJECTOR$1&&(NULL_INJECTOR$1=new NullInjector),NULL_INJECTOR$1}function createInjector(defType,parent,additionalProviders){return void 0===parent&&(parent=null),void 0===additionalProviders&&(additionalProviders=null),parent=parent||getNullInjector(),new R3Injector(defType,additionalProviders,parent)}var R3Injector=function(){function R3Injector(def,additionalProviders,parent){var _this=this;this.parent=parent,this.records=new Map,this.injectorDefTypes=new Set,this.onDestroy=new Set,this.destroyed=!1,deepForEach([def],function(injectorDef){return _this.processInjectorType(injectorDef,new Set)}),additionalProviders&&deepForEach(additionalProviders,function(provider){return _this.processProvider(provider)}),this.records.set(INJECTOR,makeRecord(void 0,this)),this.isRootInjector=this.records.has(APP_ROOT),this.injectorDefTypes.forEach(function(defType){return _this.get(defType)})}return R3Injector.prototype.destroy=function(){this.assertNotDestroyed(),this.destroyed=!0;try{this.onDestroy.forEach(function(service){return service.ngOnDestroy()})}finally{this.records.clear(),this.onDestroy.clear(),this.injectorDefTypes.clear()}},R3Injector.prototype.get=function(token,notFoundValue,flags){void 0===notFoundValue&&(notFoundValue=THROW_IF_NOT_FOUND),void 0===flags&&(flags=0),this.assertNotDestroyed();var value,previousInjector=setCurrentInjector(this);try{if(!(4&flags)){var record=this.records.get(token);if(void 0===record){var def=("function"==typeof(value=token)||"object"==typeof value&&value instanceof InjectionToken)&&token.ngInjectableDef||void 0;void 0!==def&&this.injectableDefInScope(def)&&(record=injectableDefRecord(token),this.records.set(token,record))}if(void 0!==record)return this.hydrate(token,record)}2&flags?getNullInjector():this.parent;return this.parent.get(token,notFoundValue)}finally{setCurrentInjector(previousInjector)}},R3Injector.prototype.assertNotDestroyed=function(){if(this.destroyed)throw new Error("Injector has already been destroyed.")},R3Injector.prototype.processInjectorType=function(defOrWrappedDef,parents){var _this=this,def=(defOrWrappedDef=resolveForwardRef(defOrWrappedDef)).ngInjectorDef,ngModule=null==def&&defOrWrappedDef.ngModule||void 0,defType=void 0===ngModule?defOrWrappedDef:ngModule,providers=void 0!==ngModule&&defOrWrappedDef.providers||EMPTY_ARRAY$1;if(void 0!==ngModule&&(def=ngModule.ngInjectorDef),null!=def){if(parents.has(defType))throw new Error("Circular dependency: type "+stringify(defType)+" ends up importing itself.");if(this.injectorDefTypes.add(defType),this.records.set(defType,makeRecord(def.factory)),null!=def.imports){parents.add(defType);try{deepForEach(def.imports,function(imported){return _this.processInjectorType(imported,parents)})}finally{parents.delete(defType)}}null!=def.providers&&deepForEach(def.providers,function(provider){return _this.processProvider(provider)}),deepForEach(providers,function(provider){return _this.processProvider(provider)})}},R3Injector.prototype.processProvider=function(provider){var token=isTypeProvider(provider=resolveForwardRef(provider))?provider:resolveForwardRef(provider.provide),record=function(provider){var token=resolveForwardRef(provider),value=NOT_YET,factory=void 0;if(isTypeProvider(provider))return injectableDefRecord(provider);if(token=resolveForwardRef(provider.provide),function(value){return USE_VALUE$1 in value}(provider))value=provider.useValue;else if(function(value){return!!value.useExisting}(provider))factory=function(){return inject(provider.useExisting)};else if(function(value){return!!value.useFactory}(provider))factory=function(){return provider.useFactory.apply(provider,injectArgs(provider.deps||[]))};else{var classRef_1=provider.useClass||token;if(!function(value){return!!value.deps}(provider))return injectableDefRecord(classRef_1);factory=function(){return new(classRef_1.bind.apply(classRef_1,[void 0].concat(injectArgs(provider.deps))))}}return makeRecord(factory,value)}(provider);if(isTypeProvider(provider)||!0!==provider.multi){var existing=this.records.get(token);if(existing&&void 0!==existing.multi)throw new Error("Mixed multi-provider for "+stringify(token))}else{var multiRecord_1=this.records.get(token);if(multiRecord_1){if(void 0===multiRecord_1.multi)throw new Error("Mixed multi-provider for "+token+".")}else(multiRecord_1=makeRecord(void 0,NOT_YET,!0)).factory=function(){return injectArgs(multiRecord_1.multi)},this.records.set(token,multiRecord_1);token=provider,multiRecord_1.multi.push(provider)}this.records.set(token,record)},R3Injector.prototype.hydrate=function(token,record){if(record.value===CIRCULAR$1)throw new Error("Circular dep for "+stringify(token));var value;return record.value===NOT_YET&&(record.value=CIRCULAR$1,record.value=record.factory()),"object"==typeof record.value&&record.value&&("object"==typeof(value=record.value)&&null!=value&&value.ngOnDestroy&&"function"==typeof value.ngOnDestroy)&&this.onDestroy.add(record.value),record.value},R3Injector.prototype.injectableDefInScope=function(def){return!!def.providedIn&&("string"==typeof def.providedIn?"any"===def.providedIn||"root"===def.providedIn&&this.isRootInjector:this.injectorDefTypes.has(def.providedIn))},R3Injector}();function injectableDefRecord(token){var def=token.ngInjectableDef;if(void 0===def){if(token instanceof InjectionToken)throw new Error("Token "+stringify(token)+" is missing an ngInjectableDef definition.");return makeRecord(function(){return new token})}return makeRecord(def.factory)}function makeRecord(factory,value,multi){return void 0===value&&(value=NOT_YET),void 0===multi&&(multi=!1),{factory:factory,value:value,multi:multi?[]:void 0}}function deepForEach(input,fn){input.forEach(function(value){return Array.isArray(value)?deepForEach(value,fn):fn(value)})}function isTypeProvider(value){return"function"==typeof value}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function assertEqual(actual,expected,msg){actual!=expected&&throwError(msg)}function assertNotEqual(actual,expected,msg){actual==expected&&throwError(msg)}function assertLessThan(actual,expected,msg){actual>=expected&&throwError(msg)}function assertDefined(actual,msg){null==actual&&throwError(msg)}function assertComponentType(actual,msg){void 0===msg&&(msg="Type passed in is not ComponentType, it does not have 'ngComponentDef' property."),actual.ngComponentDef||throwError(msg)}function throwError(msg){throw new Error("ASSERTION ERROR: "+msg)}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var newCounters,HEADER_OFFSET=16,TVIEW=0,PARENT=1,NEXT=2,QUERIES=3,FLAGS=4,HOST_NODE=5,BINDING_INDEX=6,DIRECTIVES=7,CLEANUP=8,CONTEXT=9,INJECTOR$1=10,RENDERER=11,SANITIZER=12,TAIL=13,CONTAINER_INDEX=14,CONTENT_QUERIES=15;
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function queueInitHooks(index,onInit,doCheck,tView){ngDevMode&&assertEqual(tView.firstTemplatePass,!0,"Should only be called on first template pass"),onInit&&(tView.initHooks||(tView.initHooks=[])).push(index,onInit),doCheck&&((tView.initHooks||(tView.initHooks=[])).push(index,doCheck),(tView.checkHooks||(tView.checkHooks=[])).push(index,doCheck))}function queueLifecycleHooks(flags,tView){if(tView.firstTemplatePass)for(var start=flags>>14,end=start+(4095&flags),i=start;i<end;i++){var def=tView.directives[i];queueContentHooks(def,tView,i),queueViewHooks(def,tView,i),queueDestroyHooks(def,tView,i)}}function queueContentHooks(def,tView,i){def.afterContentInit&&(tView.contentHooks||(tView.contentHooks=[])).push(i,def.afterContentInit),def.afterContentChecked&&((tView.contentHooks||(tView.contentHooks=[])).push(i,def.afterContentChecked),(tView.contentCheckHooks||(tView.contentCheckHooks=[])).push(i,def.afterContentChecked))}function queueViewHooks(def,tView,i){def.afterViewInit&&(tView.viewHooks||(tView.viewHooks=[])).push(i,def.afterViewInit),def.afterViewChecked&&((tView.viewHooks||(tView.viewHooks=[])).push(i,def.afterViewChecked),(tView.viewCheckHooks||(tView.viewCheckHooks=[])).push(i,def.afterViewChecked))}function queueDestroyHooks(def,tView,i){null!=def.onDestroy&&(tView.destroyHooks||(tView.destroyHooks=[])).push(i,def.onDestroy)}function executeInitHooks(currentView,tView,creationMode){16&currentView[FLAGS]&&(executeHooks(currentView[DIRECTIVES],tView.initHooks,tView.checkHooks,creationMode),currentView[FLAGS]&=-17)}function executeHooks(data,allHooks,checkHooks,creationMode){var hooksToCall=creationMode?allHooks:checkHooks;hooksToCall&&callHooks(data,hooksToCall)}function callHooks(data,arr){for(var i=0;i<arr.length;i+=2)arr[i+1].call(data[arr[i]])}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function assertNodeType(node,type){assertDefined(node,"should be called with a node"),assertEqual(node.tNode.type,type,"should be a "+typeName(type))}function assertNodeOfPossibleTypes(node){for(var types=[],_i=1;_i<arguments.length;_i++)types[_i-1]=arguments[_i];assertDefined(node,"should be called with a node"),assertEqual(types.some(function(type){return node.tNode.type===type}),!0,"Should be one of "+types.map(typeName).join(", "))}function typeName(type){return 1==type?"Projection":0==type?"Container":2==type?"View":3==type?"Element":"<unknown>"}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function stringify$1(value){return"function"==typeof value?value.name||value:"string"==typeof value?value:null==value?"":""+value}function loadInternal(index,arr){return ngDevMode&&assertDataInRangeInternal(index+HEADER_OFFSET,arr),arr[index+HEADER_OFFSET]}function assertDataInRangeInternal(index,arr){assertLessThan(index,arr?arr.length:0,"index expected to be a valid data index")}function readElementValue(value){return Array.isArray(value)?value[0]:value}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function getNextLNode(node){if(2===node.tNode.type){var viewData=node.data;return viewData[NEXT]?viewData[NEXT][HOST_NODE]:null}return node.tNode.next?node.view[node.tNode.next.index]:null}function getChildLNode(node){return node.tNode.child?readElementValue((2===node.tNode.type?node.data:node.view)[node.tNode.child.index]):null}function getParentLNode(node){if(-1===node.tNode.index&&2===node.tNode.type){var containerHostIndex=node.data[CONTAINER_INDEX];return-1===containerHostIndex?null:node.view[containerHostIndex].dynamicLContainerNode}var parent=node.tNode.parent;return readElementValue(parent?node.view[parent.index]:node.view[HOST_NODE])}var projectionNodeStack$1=[];function walkLNodeTree(startingNode,rootNode,action,renderer,renderParentNode,beforeNode){for(var node=startingNode,projectionNodeIndex=-1;node;){var nextNode=null,parent_1=renderParentNode?renderParentNode.native:null,nodeType=node.tNode.type;if(3===nodeType)executeNodeAction(action,renderer,parent_1,node.native,beforeNode),node.dynamicLContainerNode&&executeNodeAction(action,renderer,parent_1,node.dynamicLContainerNode.native,beforeNode);else if(0===nodeType){executeNodeAction(action,renderer,parent_1,node.native,beforeNode);var lContainerNode=node,childContainerData=lContainerNode.dynamicLContainerNode?lContainerNode.dynamicLContainerNode.data:lContainerNode.data;renderParentNode&&(childContainerData[RENDER_PARENT]=renderParentNode),(nextNode=childContainerData[VIEWS].length?getChildLNode(childContainerData[VIEWS][0]):null)&&(beforeNode=lContainerNode.dynamicLContainerNode?lContainerNode.dynamicLContainerNode.native:lContainerNode.native)}else if(1===nodeType){var componentHost=findComponentHost(node.view),head=componentHost.tNode.projection[node.tNode.projection];projectionNodeStack$1[++projectionNodeIndex]=node,nextNode=head?componentHost.data[PARENT][head.index]:null}else nextNode=getChildLNode(node);if(null===nextNode)for(null===(nextNode=getNextLNode(node))&&8192&node.tNode.flags&&(nextNode=getNextLNode(projectionNodeStack$1[projectionNodeIndex--]));node&&!nextNode;){if(null===(node=getParentLNode(node))||node===rootNode)return null;node.tNode.next||0!==nodeType||(beforeNode=node.native),nextNode=getNextLNode(node)}node=nextNode}}function findComponentHost(lViewData){for(var viewRootLNode=lViewData[HOST_NODE];2===viewRootLNode.tNode.type;)ngDevMode&&assertDefined(lViewData[PARENT],"lViewData.parent"),viewRootLNode=(lViewData=lViewData[PARENT])[HOST_NODE];return ngDevMode&&assertNodeType(viewRootLNode,3),ngDevMode&&assertDefined(viewRootLNode.data,"node.data"),viewRootLNode}function executeNodeAction(action,renderer,parent,node,beforeNode){0===action?isProceduralRenderer(renderer)?renderer.insertBefore(parent,node,beforeNode):parent.insertBefore(node,beforeNode,!0):1===action?isProceduralRenderer(renderer)?renderer.removeChild(parent,node):parent.removeChild(node):2===action&&(ngDevMode&&ngDevMode.rendererDestroyNode++,renderer.destroyNode(node))}function createTextNode(value,renderer){return isProceduralRenderer(renderer)?renderer.createText(stringify$1(value)):renderer.createTextNode(stringify$1(value))}function addRemoveViewFromContainer(container,rootNode,insertMode,beforeNode){ngDevMode&&assertNodeType(container,0),ngDevMode&&assertNodeType(rootNode,2);var parentNode=container.data[RENDER_PARENT];if(parentNode?parentNode.native:null){var node=getChildLNode(rootNode),renderer=container.view[RENDERER];walkLNodeTree(node,rootNode,insertMode?0:1,renderer,parentNode,beforeNode)}}function insertView(container,viewNode,index){var views=container.data[VIEWS],lView=viewNode.data;return index>0&&(views[index-1].data[NEXT]=lView),index<views.length?(lView[NEXT]=views[index].data,views.splice(index,0,viewNode)):(views.push(viewNode),lView[NEXT]=null),-1===viewNode.tNode.index&&(lView[CONTAINER_INDEX]=container.tNode.parent.index,viewNode.view=container.view),lView[QUERIES]&&lView[QUERIES].insertView(index),lView[FLAGS]|=8,viewNode}function detachView(container,removeIndex){var views=container.data[VIEWS],viewNode=views[removeIndex];removeIndex>0&&(views[removeIndex-1].data[NEXT]=viewNode.data[NEXT]),views.splice(removeIndex,1),container.tNode.detached||addRemoveViewFromContainer(container,viewNode,!1);var removedLView=viewNode.data;return removedLView[QUERIES]&&removedLView[QUERIES].removeView(),removedLView[CONTAINER_INDEX]=-1,viewNode.view=null,viewNode.data[FLAGS]&=-9,viewNode}function removeView(container,removeIndex){var viewNode=container.data[VIEWS][removeIndex];return detachView(container,removeIndex),destroyLView(viewNode.data),viewNode}function getLViewChild(viewData){if(-1===viewData[TVIEW].childIndex)return null;var hostNode=viewData[viewData[TVIEW].childIndex];return hostNode.data?hostNode.data:hostNode.dynamicLContainerNode.data}function destroyLView(view){var renderer=view[RENDERER];isProceduralRenderer(renderer)&&renderer.destroyNode&&walkLNodeTree(view[HOST_NODE],view[HOST_NODE],2,renderer),function(rootView){if(-1===rootView[TVIEW].childIndex)return cleanUpView(rootView);for(var viewOrContainer=getLViewChild(rootView);viewOrContainer;){var next=null;if(viewOrContainer.length>=HEADER_OFFSET){var view=viewOrContainer;view[TVIEW].childIndex>-1&&(next=getLViewChild(view))}else{var container=viewOrContainer;container[VIEWS].length&&(next=container[VIEWS][0].data)}if(null==next){for(;viewOrContainer&&!viewOrContainer[NEXT]&&viewOrContainer!==rootView;)cleanUpView(viewOrContainer),viewOrContainer=getParentState(viewOrContainer,rootView);cleanUpView(viewOrContainer||rootView),next=viewOrContainer&&viewOrContainer[NEXT]}viewOrContainer=next}}(view),view[FLAGS]|=32}function getParentState(state,rootView){var node;return(node=state[HOST_NODE])&&2===node.tNode.type?getParentLNode(node).data:state[PARENT]===rootView?null:state[PARENT]}function cleanUpView(viewOrContainer){if(viewOrContainer[TVIEW]){var view=viewOrContainer;!function(viewData){var cleanup=viewData[TVIEW].cleanup;if(null!=cleanup){for(var i=0;i<cleanup.length-1;i+=2)if("string"==typeof cleanup[i]){var native=readElementValue(viewData[cleanup[i+1]]).native,listener=viewData[CLEANUP][cleanup[i+2]];native.removeEventListener(cleanup[i],listener,cleanup[i+3]),i+=2}else if("number"==typeof cleanup[i]){var cleanupFn=viewData[CLEANUP][cleanup[i]];cleanupFn()}else{var context=viewData[CLEANUP][cleanup[i+1]];cleanup[i].call(context)}viewData[CLEANUP]=null}}(view),function(view){var destroyHooks,tView=view[TVIEW];null!=tView&&null!=(destroyHooks=tView.destroyHooks)&&callHooks(view[DIRECTIVES],destroyHooks)}(view),(pipeDestroyHooks=(viewData=view)[TVIEW]&&viewData[TVIEW].pipeDestroyHooks)&&callHooks(viewData,pipeDestroyHooks),-1===view[TVIEW].id&&isProceduralRenderer(view[RENDERER])&&(ngDevMode&&ngDevMode.rendererDestroy++,view[RENDERER].destroy())}var viewData,pipeDestroyHooks}function canInsertNativeNode(parent,currentView){if(ngDevMode&&assertNodeOfPossibleTypes(parent,3,2),3===parent.tNode.type)return parent.view!==currentView||null===parent.data;ngDevMode&&assertNodeType(parent,2);var grandParentContainer=getParentLNode(parent);return null!=grandParentContainer&&(ngDevMode&&assertNodeType(grandParentContainer,0),null!=grandParentContainer.data[RENDER_PARENT])}function appendChild(parent,child,currentView){if(null!==child&&canInsertNativeNode(parent,currentView)){var renderer=currentView[RENDERER];if(2===parent.tNode.type){var container=getParentLNode(parent),renderParent=container.data[RENDER_PARENT],views=container.data[VIEWS],index=views.indexOf(parent),beforeNode=index+1<views.length?getChildLNode(views[index+1]).native:container.native;isProceduralRenderer(renderer)?renderer.insertBefore(renderParent.native,child,beforeNode):renderParent.native.insertBefore(child,beforeNode,!0)}else isProceduralRenderer(renderer)?renderer.appendChild(parent.native,child):parent.native.appendChild(child);return!0}return!1}function removeChild(parent,child,currentView){if(null!==child&&canInsertNativeNode(parent,currentView)){var renderer=currentView[RENDERER];return isProceduralRenderer(renderer)?renderer.removeChild(parent.native,child):parent.native.removeChild(child),!0}return!1}function appendProjectedNode(node,currentParent,currentView,renderParent){if(appendChild(currentParent,node.native,currentView),0===node.tNode.type){var lContainer=node.data;lContainer[RENDER_PARENT]=renderParent;for(var views=lContainer[VIEWS],i=0;i<views.length;i++)addRemoveViewFromContainer(node,views[i],!0,node.native)}node.dynamicLContainerNode&&(node.dynamicLContainerNode.data[RENDER_PARENT]=renderParent,appendChild(currentParent,node.dynamicLContainerNode.native,currentView))}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var EMPTY_ARR=[],EMPTY_OBJ={};function updateStyleProp(context,index,value){var singleIndex=6+3*index,currValue=getValue(context,singleIndex),currFlag=getPointers(context,singleIndex);if(hasValueChanged(currFlag,currValue,value)){setValue(context,singleIndex,value);var indexForMulti=getMultiOrSingleIndex(currFlag),valueForMulti=getValue(context,indexForMulti);if(!valueForMulti||valueForMulti!==value){var multiDirty=!1,singleDirty=!0,isClassBased_5=2==(2&currFlag);!valueExists(value,isClassBased_5)&&valueExists(valueForMulti,isClassBased_5)&&(multiDirty=!0,singleDirty=!1),setDirty(context,indexForMulti,multiDirty),setDirty(context,singleIndex,singleDirty),setContextDirty(context,!0)}}}function renderStyling(context,renderer,styleStore,classStore){if(function(context){return isDirty(context,3)}(context)){for(var native=context[0].native,multiStartIndex=getMultiStartIndex(context),styleSanitizer=getStyleSanitizer(context),i=6;i<context.length;i+=3)if(isDirty(context,i)){var prop=getProp(context,i),value=getValue(context,i),flag=getPointers(context,i),isClassBased_6=!!(2&flag),valueToApply=value;if(i<multiStartIndex&&!valueExists(valueToApply,isClassBased_6))valueToApply=getValue(context,getMultiOrSingleIndex(flag));if(valueExists(valueToApply,isClassBased_6)||(valueToApply=getInitialValue(context,flag)),isClassBased_6)setClass(native,prop,!!valueToApply,renderer,classStore);else setStyle(native,prop,valueToApply,renderer,4&flag?styleSanitizer:null,styleStore);setDirty(context,i,!1)}setContextDirty(context,!1)}}function setStyle(native,prop,value,renderer,sanitizer,store){value=sanitizer&&value?sanitizer(prop,value):value,store?store[prop]=value:value?(ngDevMode&&ngDevMode.rendererSetStyle++,isProceduralRenderer(renderer)?renderer.setStyle(native,prop,value,RendererStyleFlags3.DashCase):native.style.setProperty(prop,value)):(ngDevMode&&ngDevMode.rendererRemoveStyle++,isProceduralRenderer(renderer)?renderer.removeStyle(native,prop,RendererStyleFlags3.DashCase):native.style.removeProperty(prop))}function setClass(native,className,add,renderer,store){store?store[className]=add:add?(ngDevMode&&ngDevMode.rendererAddClass++,isProceduralRenderer(renderer)?renderer.addClass(native,className):native.classList.add(className)):(ngDevMode&&ngDevMode.rendererRemoveClass++,isProceduralRenderer(renderer)?renderer.removeClass(native,className):native.classList.remove(className))}function setDirty(context,index,isDirtyYes){var adjustedIndex=index>=6?index+0:index;isDirtyYes?context[adjustedIndex]|=1:context[adjustedIndex]&=-2}function isDirty(context,index){return 1==(1&context[index>=6?index+0:index])}function isClassBased(context,index){return 2==(2&context[index>=6?index+0:index])}function isSanitizable(context,index){return 4==(4&context[index>=6?index+0:index])}function pointers(configFlag,staticIndex,dynamicIndex){return 7&configFlag|staticIndex<<3|dynamicIndex<<17}function getInitialValue(context,flag){var index=getInitialIndex(flag);return context[2][index]}function getInitialIndex(flag){return flag>>3&16383}function getMultiOrSingleIndex(flag){var index=flag>>17&16383;return index>=6?index:-1}function getMultiStartIndex(context){return getMultiOrSingleIndex(context[3])}function getStyleSanitizer(context){return context[1]}function setProp(context,index,prop){context[index+1]=prop}function setValue(context,index,value){context[index+2]=value}function setFlag(context,index,flag){context[3===index?index:index+0]=flag}function getPointers(context,index){return context[3===index?index:index+0]}function getValue(context,index){return context[index+2]}function getProp(context,index){return context[index+1]}function setContextDirty(context,isDirtyYes){setDirty(context,3,isDirtyYes)}function findEntryPositionByProp(context,prop,startIndex){for(var i=(startIndex||0)+1;i<context.length;i+=3){if(context[i]==prop)return i-1}return-1}function swapMultiContextEntries(context,indexA,indexB){var tmpValue=getValue(context,indexA),tmpProp=getProp(context,indexA),tmpFlag=getPointers(context,indexA),flagA=tmpFlag,flagB=getPointers(context,indexB),singleIndexA=getMultiOrSingleIndex(flagA);singleIndexA>=0&&setFlag(context,singleIndexA,pointers(_flag=getPointers(context,singleIndexA),getInitialIndex(_flag),indexB));var _flag,singleIndexB=getMultiOrSingleIndex(flagB);singleIndexB>=0&&setFlag(context,singleIndexB,pointers(_flag=getPointers(context,singleIndexB),getInitialIndex(_flag),indexA));setValue(context,indexA,getValue(context,indexB)),setProp(context,indexA,getProp(context,indexB)),setFlag(context,indexA,getPointers(context,indexB)),setValue(context,indexB,tmpValue),setProp(context,indexB,tmpProp),setFlag(context,indexB,tmpFlag)}function insertNewMultiProperty(context,index,classBased,name,flag,value){var doShift=index<context.length;context.splice(index,0,1|flag|(classBased?2:0),name,value),doShift&&function(context,indexStartPosition){for(var i=indexStartPosition;i<context.length;i+=3){var singleIndex=getMultiOrSingleIndex(getPointers(context,i));if(singleIndex>0){var initialIndexForSingle=getInitialIndex(getPointers(context,singleIndex));setFlag(context,singleIndex,pointers((isDirty(context,singleIndex)?1:0)|(isClassBased(context,singleIndex)?2:0)|(isSanitizable(context,singleIndex)?4:0),initialIndexForSingle,i))}}}(context,index+3)}function valueExists(value,isClassBased){return isClassBased?!!value:null!==value}function prepareInitialFlag(name,isClassBased,sanitizer){return isClassBased?2:sanitizer&&sanitizer(name)?4:0}function hasValueChanged(flag,a,b){return!(2&flag)&&(a&&b)&&4&flag?a.toString()!==b.toString():a!==b}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var renderer,rendererFactory,previousOrParentNode,isParent,tView,currentQueries,creationMode,viewData,directives,NG_HOST_SYMBOL="__ngHostLNode__",_CLEAN_PROMISE=Promise.resolve(null),_ROOT_DIRECTIVE_INDICES=[0,0],HEADER_FILLER=new Array(HEADER_OFFSET).fill(null),CIRCULAR$2="__CIRCULAR__",currentElementNode=null;function getRenderer(){return renderer}function getCurrentSanitizer(){return viewData&&viewData[SANITIZER]}function getViewData(){return viewData}function getPreviousOrParentNode(){return previousOrParentNode}function getCleanup(view){return view[CLEANUP]||(view[CLEANUP]=[])}function getTViewCleanup(view){return view[TVIEW].cleanup||(view[TVIEW].cleanup=[])}var checkNoChangesMode=!1,firstTemplatePass=!0;function enterView(newView,host){var oldView=viewData;return directives=newView&&newView[DIRECTIVES],tView=newView&&newView[TVIEW],creationMode=newView&&1==(1&newView[FLAGS]),firstTemplatePass=newView&&tView.firstTemplatePass,renderer=newView&&newView[RENDERER],null!=host&&(previousOrParentNode=host,isParent=!0),viewData=newView,currentQueries=newView&&newView[QUERIES],oldView}function leaveView(newView,creationOnly){creationOnly||(checkNoChangesMode||executeHooks(directives,tView.viewHooks,tView.viewCheckHooks,creationMode),viewData[FLAGS]&=-6),viewData[FLAGS]|=16,viewData[BINDING_INDEX]=-1,enterView(newView,null)}function refreshView(){checkNoChangesMode||executeInitHooks(viewData,tView,creationMode),function(lViewData){for(var current=getLViewChild(lViewData);null!==current;current=current[NEXT])if(current.length<HEADER_OFFSET&&null===current[ACTIVE_INDEX])for(var container_1=current,i=0;i<container_1[VIEWS].length;i++){var lViewNode=container_1[VIEWS][i],dynamicViewData=lViewNode.data;ngDevMode&&assertDefined(dynamicViewData[TVIEW],"TView must be allocated"),renderEmbeddedTemplate(lViewNode,dynamicViewData[TVIEW],dynamicViewData[CONTEXT],2)}}(viewData),checkNoChangesMode||executeHooks(directives,tView.contentHooks,tView.contentCheckHooks,creationMode),tView.firstTemplatePass=firstTemplatePass=!1,setHostBindings(tView.hostBindings),function(tView){if(null!=tView.contentQueries)for(var i=0;i<tView.contentQueries.length;i+=2){var directiveDefIdx=tView.contentQueries[i],directiveDef=tView.directives[directiveDefIdx];directiveDef.contentQueriesRefresh(directiveDefIdx,tView.contentQueries[i+1])}}(tView),function(components){if(null!=components)for(var i=0;i<components.length;i+=2)componentRefresh(components[i],components[i+1])}(tView.components)}function setHostBindings(bindings){if(null!=bindings)for(var defs=tView.directives,i=0;i<bindings.length;i+=2){var dirIndex=bindings[i],def=defs[dirIndex];def.hostBindings&&def.hostBindings(dirIndex,bindings[i+1])}}function executeInitAndContentHooks(){checkNoChangesMode||(executeInitHooks(viewData,tView,creationMode),executeHooks(directives,tView.contentHooks,tView.contentCheckHooks,creationMode))}function createLViewData(renderer,tView,context,flags,sanitizer){return[tView,viewData,null,null,25|flags,null,-1,null,null,context,viewData&&viewData[INJECTOR$1],renderer,sanitizer||null,null,-1,null]}function createLNodeObject(type,currentView,parent,native,state,queries){return{native:native,view:currentView,nodeInjector:parent?parent.nodeInjector:null,data:state,queries:queries,tNode:null,dynamicLContainerNode:null}}function createLNode(index,type,native,name,attrs,state){var parent=isParent?previousOrParentNode:previousOrParentNode&&getParentLNode(previousOrParentNode),tParent=parent&&parent.view===viewData?parent.tNode:null,queries=(isParent?currentQueries:previousOrParentNode&&previousOrParentNode.queries)||parent&&parent.queries&&parent.queries.child(),isState=null!=state,node=createLNodeObject(0,viewData,parent,native,isState?state:null,queries);if(-1===index||2===type)node.tNode=(state?state[TVIEW].node:null)||createTNode(type,index,null,null,tParent,null);else{var adjustedIndex=index+HEADER_OFFSET;ngDevMode&&assertDataNext(adjustedIndex);var tData=tView.data;if(viewData[adjustedIndex]=node,adjustedIndex>=tData.length){var tNode=tData[adjustedIndex]=createTNode(type,adjustedIndex,name,attrs,tParent,null);if(!isParent&&previousOrParentNode){var previousTNode=previousOrParentNode.tNode;previousTNode.next=tNode,previousTNode.dynamicContainerNode&&(previousTNode.dynamicContainerNode.next=tNode)}}node.tNode=tData[adjustedIndex],isParent&&(currentQueries=null,(null==previousOrParentNode.tNode.child&&previousOrParentNode.view===viewData||2===previousOrParentNode.tNode.type)&&(previousOrParentNode.tNode.child=node.tNode))}if(2==(2&type)&&isState){var lViewData=state;ngDevMode&&(null!=lViewData[HOST_NODE]&&throwError("lViewData[HOST_NODE] should not have been initialized")),lViewData[HOST_NODE]=node,firstTemplatePass&&(lViewData[TVIEW].node=node.tNode)}return previousOrParentNode=node,isParent=!0,node}function resetApplicationState(){isParent=!1,previousOrParentNode=null}function renderEmbeddedTemplate(viewNode,tView,context,rf){var oldView,_isParent=isParent,_previousOrParentNode=previousOrParentNode;if(null==viewNode.data[PARENT]&&viewNode.data[CONTEXT]&&!tView.template)tickRootContext(viewNode.data[CONTEXT]);else try{isParent=!0,previousOrParentNode=null,oldView=enterView(viewNode.data,viewNode),namespaceHTML(),tView.template(rf,context),2&rf?refreshView():viewNode.data[TVIEW].firstTemplatePass=firstTemplatePass=!1}finally{leaveView(oldView,1==(1&rf)),isParent=_isParent,previousOrParentNode=_previousOrParentNode}return viewNode}function renderComponentOrTemplate(node,hostView,componentOrContext,template){var oldView=enterView(hostView,node);try{rendererFactory.begin&&rendererFactory.begin(),template?(namespaceHTML(),template(getRenderFlags(hostView),componentOrContext),refreshView()):(executeInitAndContentHooks(),setHostBindings(_ROOT_DIRECTIVE_INDICES),componentRefresh(0,HEADER_OFFSET))}finally{rendererFactory.end&&rendererFactory.end(),leaveView(oldView)}}function getRenderFlags(view){return 1&view[FLAGS]?3:2}var _currentNamespace=null;function namespaceHTML(){_currentNamespace=null}function elementStart(index,name,attrs,localRefs){ngDevMode&&assertEqual(viewData[BINDING_INDEX],-1,"elements should be created before any bindings"),ngDevMode&&ngDevMode.rendererCreateElement++;var native=elementCreate(name);ngDevMode&&assertDataInRange(index-1);var node=createLNode(index,3,native,name,attrs||null,null);return currentElementNode=node,attrs&&setUpAttributes(native,attrs),appendChild(getParentLNode(node),native,viewData),createDirectivesAndLocals(localRefs),native}function elementCreate(name,overriddenRenderer){var rendererToUse=overriddenRenderer||renderer;return isProceduralRenderer(rendererToUse)?rendererToUse.createElement(name,_currentNamespace):null===_currentNamespace?rendererToUse.createElement(name):rendererToUse.createElementNS(_currentNamespace,name)}function createDirectivesAndLocals(localRefs){var node=previousOrParentNode;firstTemplatePass?(ngDevMode&&ngDevMode.firstTemplatePass++,function(tNode,tView,localRefs){var exportsMap=localRefs?{"":-1}:null,matches=tView.currentMatches=findDirectiveMatches(tNode);if(matches)for(var i=0;i<matches.length;i+=2){var def=matches[i],valueIndex=i+1;resolveDirective(def,valueIndex,matches,tView),saveNameToExportMap(matches[valueIndex],def,exportsMap)}exportsMap&&function(tNode,localRefs,exportsMap){if(localRefs)for(var localNames=tNode.localNames=[],i=0;i<localRefs.length;i+=2){var index=exportsMap[localRefs[i+1]];if(null==index)throw new Error("Export of name '"+localRefs[i+1]+"' not found!");localNames.push(localRefs[i],index)}}(tNode,localRefs,exportsMap)}(node.tNode,tView,localRefs||null)):function(){var tNode=previousOrParentNode.tNode,count=4095&tNode.flags;if(count>0)for(var start=tNode.flags>>14,end=start+count,tDirectives=tView.directives,i=start;i<end;i++){var def=tDirectives[i];directiveCreate(i,def.factory(),def)}}(),function(){var localNames=previousOrParentNode.tNode.localNames;if(localNames)for(var i=0;i<localNames.length;i+=2){var index=localNames[i+1],value=-1===index?previousOrParentNode.native:directives[index];viewData.push(value)}}()}function findDirectiveMatches(tNode){var registry=tView.directiveRegistry,matches=null;if(registry)for(var i=0;i<registry.length;i++){var def=registry[i];isNodeMatchingSelectorList(tNode,def.selectors)&&(def.template&&(4096&tNode.flags&&throwMultipleComponentError(tNode),tNode.flags=4096),def.diPublic&&def.diPublic(def),(matches||(matches=[])).push(def,null))}return matches}function resolveDirective(def,valueIndex,matches,tView){if(null===matches[valueIndex]){matches[valueIndex]=CIRCULAR$2;var instance=def.factory();return(tView.directives||(tView.directives=[])).push(def),directiveCreate(matches[valueIndex]=tView.directives.length-1,instance,def)}return matches[valueIndex]===CIRCULAR$2&&function(token){throw new Error("Cannot instantiate cyclic dependency! "+token)}(def.type),null}function queueComponentIndexForCheck(dirIndex){firstTemplatePass&&(tView.components||(tView.components=[])).push(dirIndex,viewData.length-1)}function initChangeDetectorIfExisting(injector,instance,view){injector&&null!=injector.changeDetectorRef&&injector.changeDetectorRef._setComponentContext(view,instance)}function saveNameToExportMap(index,def,exportsMap){exportsMap&&(def.exportAs&&(exportsMap[def.exportAs]=index),def.template&&(exportsMap[""]=index))}function getOrCreateTView(template,directives,pipes,viewQuery){return template.ngPrivateData||(template.ngPrivateData=createTView(-1,template,directives,pipes,viewQuery))}function createTView(viewIndex,template,directives,pipes,viewQuery){return ngDevMode&&ngDevMode.tView++,{id:viewIndex,template:template,viewQuery:viewQuery,node:null,data:HEADER_FILLER.slice(),childIndex:-1,bindingStartIndex:-1,directives:null,firstTemplatePass:!0,initHooks:null,checkHooks:null,contentHooks:null,contentCheckHooks:null,viewHooks:null,viewCheckHooks:null,destroyHooks:null,pipeDestroyHooks:null,cleanup:null,hostBindings:null,contentQueries:null,components:null,directiveRegistry:"function"==typeof directives?directives():directives,pipeRegistry:"function"==typeof pipes?pipes():pipes,currentMatches:null}}function setUpAttributes(native,attrs){for(var isProc=isProceduralRenderer(renderer),i=0;i<attrs.length;){var attrName=attrs[i];if(1===attrName)break;if(attrName===NG_PROJECT_AS_ATTR_NAME)i+=2;else if(ngDevMode&&ngDevMode.rendererSetAttribute++,0===attrName){var namespaceURI=attrs[i+1],attrName_1=attrs[i+2],attrVal=attrs[i+3];isProc?renderer.setAttribute(native,attrName_1,attrVal,namespaceURI):native.setAttributeNS(namespaceURI,attrName_1,attrVal),i+=4}else{attrVal=attrs[i+1];isProc?renderer.setAttribute(native,attrName,attrVal):native.setAttribute(attrName,attrVal),i+=2}}}function createError(text,token){return new Error("Renderer: "+text+" ["+stringify$1(token)+"]")}function locateHostElement(factory,elementOrSelector){ngDevMode&&assertDataInRange(-1),rendererFactory=factory;var defaultRenderer=factory.createRenderer(null,null),rNode="string"==typeof elementOrSelector?isProceduralRenderer(defaultRenderer)?defaultRenderer.selectRootElement(elementOrSelector):defaultRenderer.querySelector(elementOrSelector):elementOrSelector;if(ngDevMode&&!rNode)throw createError("string"==typeof elementOrSelector?"Host node with selector not found:":"Host node is required:",elementOrSelector);return rNode}function hostElement(tag,rNode,def,sanitizer){resetApplicationState();var node=createLNode(0,3,rNode,null,null,createLViewData(renderer,getOrCreateTView(def.template,def.directiveDefs,def.pipeDefs,def.viewQuery),null,def.onPush?4:2,sanitizer));return firstTemplatePass&&(node.tNode.flags=4096,def.diPublic&&def.diPublic(def),tView.directives=[def]),node}function storeCleanupWithContext(view,context,cleanupFn){view||(view=viewData),getCleanup(view).push(context),view[TVIEW].firstTemplatePass&&getTViewCleanup(view).push(cleanupFn,view[CLEANUP].length-1)}function storeCleanupFn(view,cleanupFn){getCleanup(view).push(cleanupFn),view[TVIEW].firstTemplatePass&&getTViewCleanup(view).push(view[CLEANUP].length-1,null)}function elementEnd(){isParent?isParent=!1:(ngDevMode&&assertHasParent(),previousOrParentNode=getParentLNode(previousOrParentNode)),ngDevMode&&assertNodeType(previousOrParentNode,3);var queries=previousOrParentNode.queries;queries&&queries.addNode(previousOrParentNode),queueLifecycleHooks(previousOrParentNode.tNode.flags,tView),currentElementNode=null}function createTNode(type,adjustedIndex,tagName,attrs,parent,tViews){return ngDevMode&&ngDevMode.tNode++,{type:type,index:adjustedIndex,flags:0,tagName:tagName,attrs:attrs,localNames:null,initialInputs:void 0,inputs:void 0,outputs:void 0,tViews:tViews,next:null,child:null,parent:parent,dynamicContainerNode:null,detached:null,stylingTemplate:null,projection:null}}function generatePropertyAliases(tNodeFlags,direction){var count=4095&tNodeFlags,propStore=null;if(count>0)for(var start=tNodeFlags>>14,end=start+count,isInput=0===direction,defs=tView.directives,i=start;i<end;i++){var directiveDef=defs[i],propertyAliasMap=isInput?directiveDef.inputs:directiveDef.outputs;for(var publicName in propertyAliasMap)if(propertyAliasMap.hasOwnProperty(publicName)){propStore=propStore||{};var internalName=propertyAliasMap[publicName];propStore.hasOwnProperty(publicName)?propStore[publicName].push(i,internalName):propStore[publicName]=[i,internalName]}}return propStore}function getStylingContext(index){var stylingContext=load(index);if(!Array.isArray(stylingContext)){var lElement=stylingContext,tNode=lElement.tNode;ngDevMode&&assertDefined(tNode.stylingTemplate,"getStylingContext() called before elementStyling()"),stylingContext=viewData[index+HEADER_OFFSET]=function(lElement,templateStyleContext){var context=templateStyleContext.slice();return context[0]=lElement,context}(lElement,tNode.stylingTemplate)}return stylingContext}function elementStylingApply(index){renderStyling(getStylingContext(index),renderer)}function directiveCreate(directiveDefIdx,directive,directiveDef){var instance=baseDirectiveCreate(directiveDefIdx,directive,directiveDef);ngDevMode&&assertDefined(previousOrParentNode.tNode,"previousOrParentNode.tNode");var dirIndex,tNode=previousOrParentNode.tNode;return directiveDef.template&&function(directiveIndex,instance,def){var tView=getOrCreateTView(def.template,def.directiveDefs,def.pipeDefs,def.viewQuery),componentView=addToViewTree(viewData,previousOrParentNode.tNode.index,createLViewData(rendererFactory.createRenderer(previousOrParentNode.native,def.rendererType),tView,null,def.onPush?4:2,getCurrentSanitizer()));previousOrParentNode.data=componentView,componentView[HOST_NODE]=previousOrParentNode,initChangeDetectorIfExisting(previousOrParentNode.nodeInjector,instance,componentView),firstTemplatePass&&queueComponentIndexForCheck(directiveIndex)}(directiveDefIdx,directive,directiveDef),firstTemplatePass&&(queueInitHooks(directiveDefIdx,directiveDef.onInit,directiveDef.doCheck,tView),directiveDef.hostBindings&&(dirIndex=directiveDefIdx,ngDevMode&&assertEqual(firstTemplatePass,!0,"Should only be called in first template pass."),(tView.hostBindings||(tView.hostBindings=[])).push(dirIndex,viewData.length-1-HEADER_OFFSET))),tNode&&tNode.attrs&&function(directiveIndex,instance,inputs,tNode){var initialInputData=tNode.initialInputs;(void 0===initialInputData||directiveIndex>=initialInputData.length)&&(initialInputData=function(directiveIndex,inputs,tNode){var initialInputData=tNode.initialInputs||(tNode.initialInputs=[]);initialInputData[directiveIndex]=null;var attrs=tNode.attrs,i=0;for(;i<attrs.length;){var attrName=attrs[i];if(1===attrName)break;if(0!==attrName){var minifiedInputName=inputs[attrName],attrValue=attrs[i+1];if(void 0!==minifiedInputName){var inputsToStore=initialInputData[directiveIndex]||(initialInputData[directiveIndex]=[]);inputsToStore.push(minifiedInputName,attrValue)}i+=2}else i+=4}return initialInputData}(directiveIndex,inputs,tNode));var initialInputs=initialInputData[directiveIndex];if(initialInputs)for(var i=0;i<initialInputs.length;i+=2)instance[initialInputs[i]]=initialInputs[i+1]}(directiveDefIdx,instance,directiveDef.inputs,tNode),directiveDef.contentQueries&&directiveDef.contentQueries(),instance}function baseDirectiveCreate(index,directive,directiveDef){if(ngDevMode&&assertEqual(viewData[BINDING_INDEX],-1,"directives should be created before any bindings"),ngDevMode&&assertPreviousIsParent(),Object.defineProperty(directive,NG_HOST_SYMBOL,{enumerable:!1,value:previousOrParentNode}),null==directives&&(viewData[DIRECTIVES]=directives=[]),ngDevMode&&assertDataNext(index,directives),directives[index]=directive,firstTemplatePass){var flags=previousOrParentNode.tNode.flags;0==(4095&flags)?previousOrParentNode.tNode.flags=index<<14|4096&flags|1:(ngDevMode&&assertNotEqual(4095&flags,4095,"Reached the max number of directives"),previousOrParentNode.tNode.flags++)}else{var diPublic=directiveDef.diPublic;diPublic&&diPublic(directiveDef)}return null!=directiveDef.attributes&&3==previousOrParentNode.tNode.type&&setUpAttributes(previousOrParentNode.native,directiveDef.attributes),directive}function createLContainer(parentLNode,currentView,isForViewContainerRef){ngDevMode&&assertDefined(parentLNode,"containers should have a parent");var renderParent=canInsertNativeNode(parentLNode,currentView)?parentLNode:null;return renderParent&&2===renderParent.tNode.type&&(renderParent=getParentLNode(renderParent).data[RENDER_PARENT]),[isForViewContainerRef?null:0,currentView,null,null,[],renderParent]}function componentRefresh(directiveIndex,adjustedElementIndex){ngDevMode&&assertDataInRange(adjustedElementIndex);var element=viewData[adjustedElementIndex];ngDevMode&&assertNodeType(element,3),ngDevMode&&assertDefined(element.data,"Component's host node should have an LViewData attached.");var hostView=element.data;viewAttached(hostView)&&6&hostView[FLAGS]&&(ngDevMode&&assertDataInRange(directiveIndex,directives),detectChangesInternal(hostView,element,directives[directiveIndex]))}function viewAttached(view){return 8==(8&view[FLAGS])}var projectionNodeStack=[];function addToViewTree(currentView,adjustedHostIndex,state){return currentView[TAIL]?currentView[TAIL][NEXT]=state:firstTemplatePass&&(tView.childIndex=adjustedHostIndex),currentView[TAIL]=state,state}function markViewDirty(view){for(var currentView=view;null!=currentView[PARENT];)currentView[FLAGS]|=4,currentView=currentView[PARENT];currentView[FLAGS]|=4,ngDevMode&&assertDefined(currentView[CONTEXT],"rootContext"),function(rootContext){if(rootContext.clean==_CLEAN_PROMISE){var res_1=void 0;rootContext.clean=new Promise(function(r){return res_1=r}),rootContext.scheduler(function(){tickRootContext(rootContext),res_1(null),rootContext.clean=_CLEAN_PROMISE})}}(currentView[CONTEXT])}function tickRootContext(rootContext){for(var i=0;i<rootContext.components.length;i++){var rootComponent=rootContext.components[i],hostNode=_getComponentHostLElementNode(rootComponent);ngDevMode&&assertDefined(hostNode.data,"Component host node should be attached to an LView"),renderComponentOrTemplate(hostNode,getRootView(rootComponent),rootComponent)}}function getRootView(component){ngDevMode&&assertDefined(component,"component");for(var lViewData=_getComponentHostLElementNode(component).view;lViewData[PARENT];)lViewData=lViewData[PARENT];return lViewData}function detectChanges(component){var hostNode=_getComponentHostLElementNode(component);ngDevMode&&assertDefined(hostNode.data,"Component host node should be attached to an LViewData instance."),detectChangesInternal(hostNode.data,hostNode,component)}function detectChangesInternal(hostView,hostNode,component){var oldView=enterView(hostView,hostNode),hostTView=hostView[TVIEW],template=hostTView.template,viewQuery=hostTView.viewQuery;try{namespaceHTML(),function(viewQuery,flags,component){viewQuery&&1&flags&&viewQuery(1,component)}(viewQuery,hostView[FLAGS],component),template(getRenderFlags(hostView),component),refreshView(),function(viewQuery,component){viewQuery&&viewQuery(2,component)}(viewQuery,component)}finally{leaveView(oldView)}}var NO_CHANGE={};function initBindings(){ngDevMode&&assertEqual(viewData[BINDING_INDEX],-1,"Binding index should not yet be set "+viewData[BINDING_INDEX]),-1===tView.bindingStartIndex&&(tView.bindingStartIndex=viewData.length),viewData[BINDING_INDEX]=tView.bindingStartIndex}function moveBindingIndexToReservedSlot(offset){var currentSlot=viewData[BINDING_INDEX];return viewData[BINDING_INDEX]=tView.bindingStartIndex-offset,currentSlot}function restoreBindingIndex(index){viewData[BINDING_INDEX]=index}function store(index,value){var adjustedIndex=index+HEADER_OFFSET;adjustedIndex>=tView.data.length&&(tView.data[adjustedIndex]=null),viewData[adjustedIndex]=value}function load(index){return loadInternal(index,viewData)}function loadElement(index){return function(index,arr){return readElementValue(loadInternal(index,arr))}(index,viewData)}function consumeBinding(){return ngDevMode&&assertDataInRange(viewData[BINDING_INDEX]),ngDevMode&&assertNotEqual(viewData[viewData[BINDING_INDEX]],NO_CHANGE,"Stored value should never be NO_CHANGE."),viewData[viewData[BINDING_INDEX]++]}function bindingUpdated(value){ngDevMode&&assertNotEqual(value,NO_CHANGE,"Incoming value should never be NO_CHANGE."),-1===viewData[BINDING_INDEX]&&initBindings();var a,b,bindingIndex=viewData[BINDING_INDEX];if(bindingIndex>=viewData.length)viewData[viewData[BINDING_INDEX]++]=value;else{if(a=viewData[bindingIndex],b=value,a!=a&&b!=b||a===b)return viewData[BINDING_INDEX]++,!1;!function(creationMode,checkNoChangesMode,oldValue,currValue){if(checkNoChangesMode){var msg="ExpressionChangedAfterItHasBeenCheckedError: Expression has changed after it was checked. Previous value: '"+oldValue+"'. Current value: '"+currValue+"'.";throw creationMode&&(msg+=" It seems like the view has been created after its parent and its children have been dirty checked. Has it been created in a change detection hook ?"),new Error(msg)}}(creationMode,checkNoChangesMode,viewData[bindingIndex],value),viewData[viewData[BINDING_INDEX]++]=value}return!0}function checkAndUpdateBinding$1(value){return bindingUpdated(value),value}function bindingUpdated2(exp1,exp2){var different=bindingUpdated(exp1);return bindingUpdated(exp2)||different}function bindingUpdated4(exp1,exp2,exp3,exp4){var different=bindingUpdated2(exp1,exp2);return bindingUpdated2(exp3,exp4)||different}function getTView(){return tView}function assertPreviousIsParent(){assertEqual(isParent,!0,"previousOrParentNode should be a parent")}function assertHasParent(){assertDefined(getParentLNode(previousOrParentNode),"previousOrParentNode should have a parent")}function assertDataInRange(index,arr){null==arr&&(arr=viewData),assertDataInRangeInternal(index,arr||viewData)}function assertDataNext(index,arr){null==arr&&(arr=viewData),assertEqual(arr.length,index,"index "+index+" expected to be at the end of arr (length "+arr.length+")")}function assertReservedSlotInitialized(slotOffset,numSlots){if(firstTemplatePass)for(var startIndex=tView.bindingStartIndex-slotOffset,i=0;i<numSlots;i++)assertEqual(viewData[startIndex+i],NO_CHANGE,"The reserved slots should be set to `NO_CHANGE` on first template pass")}function _getComponentHostLElementNode(component){ngDevMode&&assertDefined(component,"expecting component got null");var lElementNode=component[NG_HOST_SYMBOL];return ngDevMode&&assertDefined(component,"object is not a component"),lElementNode}var CLEAN_PROMISE=_CLEAN_PROMISE,ROOT_DIRECTIVE_INDICES=_ROOT_DIRECTIVE_INDICES;function createRootContext(scheduler){return{components:[],scheduler:scheduler,clean:CLEAN_PROMISE}}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
var PRIVATE_PREFIX="__ngOnChanges_";function onChangesWrapper(delegateHook){return function(){var simpleChanges=this[PRIVATE_PREFIX];null!=simpleChanges&&(this.ngOnChanges(simpleChanges),this[PRIVATE_PREFIX]=null),delegateHook&&delegateHook.apply(this)}}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var ViewRef$1=function(){function ViewRef(_view,context){this._view=_view,this._appRef=null,this._viewContainerRef=null,this._lViewNode=null,this.context=context}return ViewRef.prototype._setComponentContext=function(view,context){this._view=view,this.context=context},Object.defineProperty(ViewRef.prototype,"destroyed",{get:function(){return 32==(32&this._view[FLAGS])},enumerable:!0,configurable:!0}),ViewRef.prototype.destroy=function(){this._viewContainerRef&&viewAttached(this._view)&&(this._viewContainerRef.detach(this._viewContainerRef.indexOf(this)),this._viewContainerRef=null),destroyLView(this._view)},ViewRef.prototype.onDestroy=function(callback){storeCleanupFn(this._view,callback)},ViewRef.prototype.markForCheck=function(){markViewDirty(this._view)},ViewRef.prototype.detach=function(){this._view[FLAGS]&=-9},ViewRef.prototype.reattach=function(){this._view[FLAGS]|=8},ViewRef.prototype.detectChanges=function(){detectChanges(this.context)},ViewRef.prototype.checkNoChanges=function(){!function(component){checkNoChangesMode=!0;try{detectChanges(component)}finally{checkNoChangesMode=!1}}(this.context)},ViewRef.prototype.attachToViewContainerRef=function(vcRef){this._viewContainerRef=vcRef},ViewRef.prototype.detachFromAppRef=function(){this._appRef=null},ViewRef.prototype.attachToAppRef=function(appRef){this._appRef=appRef},ViewRef}(),ComponentFactoryResolver$1=function(_super){function ComponentFactoryResolver$$1(){return null!==_super&&_super.apply(this,arguments)||this}return __extends(ComponentFactoryResolver$$1,_super),ComponentFactoryResolver$$1.prototype.resolveComponentFactory=function(component){ngDevMode&&assertComponentType(component);var componentDef=component.ngComponentDef;return new ComponentFactory$1(componentDef)},ComponentFactoryResolver$$1}(ComponentFactoryResolver);
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function toRefArray(map){var array=[];for(var nonMinified in map)if(map.hasOwnProperty(nonMinified)){var minified=map[nonMinified];array.push({propName:minified,templateName:nonMinified})}return array}var ROOT_CONTEXT=new InjectionToken("ROOT_CONTEXT_TOKEN",{providedIn:"root",factory:function(){return createRootContext(inject(SCHEDULER))}}),SCHEDULER=new InjectionToken("SCHEDULER_TOKEN",{providedIn:"root",factory:function(){return requestAnimationFrame.bind(window)}}),ComponentFactory$1=function(_super){function ComponentFactory$$1(componentDef){var _this=_super.call(this)||this;return _this.componentDef=componentDef,_this.componentType=componentDef.type,_this.selector=componentDef.selectors[0][0],_this.ngContentSelectors=[],_this}return __extends(ComponentFactory$$1,_super),Object.defineProperty(ComponentFactory$$1.prototype,"inputs",{get:function(){return toRefArray(this.componentDef.inputs)},enumerable:!0,configurable:!0}),Object.defineProperty(ComponentFactory$$1.prototype,"outputs",{get:function(){return toRefArray(this.componentDef.outputs)},enumerable:!0,configurable:!0}),ComponentFactory$$1.prototype.create=function(injector,projectableNodes,rootSelectorOrNode,ngModule){var isInternalRootView=void 0===rootSelectorOrNode,rendererFactory=ngModule?ngModule.injector.get(RendererFactory2):domRendererFactory3,hostNode=isInternalRootView?elementCreate(this.selector,rendererFactory.createRenderer(null,this.componentDef.rendererType)):locateHostElement(rendererFactory,rootSelectorOrNode),rootContext=(this.componentDef.selectors[0][0],ngModule&&!isInternalRootView?ngModule.injector.get(ROOT_CONTEXT):createRootContext(requestAnimationFrame.bind(window))),rootView=createLViewData(rendererFactory.createRenderer(hostNode,this.componentDef.rendererType),createTView(-1,null,null,null,null),rootContext,this.componentDef.onPush?4:2);rootView[INJECTOR$1]=ngModule&&ngModule.injector||null;var component,elementNode,oldView=enterView(rootView,null);try{if(rendererFactory.begin&&rendererFactory.begin(),elementNode=hostElement(0,hostNode,this.componentDef),rootContext.components.push(component=baseDirectiveCreate(0,this.componentDef.factory(),this.componentDef)),initChangeDetectorIfExisting(elementNode.nodeInjector,component,elementNode.data),function(component,def){var elementNode=_getComponentHostLElementNode(component),tView=elementNode.view[TVIEW];queueInitHooks(0,def.onInit,def.doCheck,tView),queueLifecycleHooks(elementNode.tNode.flags,tView)}(component,this.componentDef),projectableNodes)for(var index=0,projection$$1=elementNode.tNode.projection=[],i=0;i<projectableNodes.length;i++){for(var nodeList=projectableNodes[i],firstTNode=null,previousTNode=null,j=0;j<nodeList.length;j++){var lNode=createLNode(++index,3,nodeList[j],null,null);previousTNode?previousTNode.next=lNode.tNode:firstTNode=lNode.tNode,previousTNode=lNode.tNode}projection$$1.push(firstTNode)}renderEmbeddedTemplate(elementNode,elementNode.data[TVIEW],component,1),elementNode.data[FLAGS]&=-2}finally{enterView(oldView,null),rendererFactory.end&&rendererFactory.end()}var componentRef=new ComponentRef$1(this.componentType,component,rootView,injector,hostNode);return isInternalRootView&&(componentRef.hostView._lViewNode.tNode.child=elementNode.tNode),componentRef},ComponentFactory$$1}(ComponentFactory),ComponentRef$1=function(_super){function ComponentRef$$1(componentType,instance,rootView,injector,hostNode){var _this=_super.call(this)||this;return _this.destroyCbs=[],_this.instance=instance,_this.hostView=_this.changeDetectorRef=new ViewRef$1(rootView,instance),_this.hostView._lViewNode=createLNode(-1,2,null,null,null,rootView),_this.injector=injector,_this.location=new ElementRef(hostNode),_this.componentType=componentType,_this}return __extends(ComponentRef$$1,_super),ComponentRef$$1.prototype.destroy=function(){ngDevMode&&assertDefined(this.destroyCbs,"NgModule already destroyed"),this.destroyCbs.forEach(function(fn){return fn()}),this.destroyCbs=null},ComponentRef$$1.prototype.onDestroy=function(callback){ngDevMode&&assertDefined(this.destroyCbs,"NgModule already destroyed"),this.destroyCbs.push(callback)},ComponentRef$$1}(ComponentRef),NG_ELEMENT_ID="__NG_ELEMENT_ID__",BLOOM_SIZE=256,nextNgElementId=0;function getOrCreateNodeInjector(){return ngDevMode&&assertPreviousIsParent(),getOrCreateNodeInjectorForNode(getPreviousOrParentNode())}function getOrCreateNodeInjectorForNode(node){var nodeInjector=node.nodeInjector,parent=getParentLNode(node),parentInjector=parent&&parent.nodeInjector;return nodeInjector!=parentInjector?nodeInjector:node.nodeInjector={parent:parentInjector,node:node,bf0:0,bf1:0,bf2:0,bf3:0,bf4:0,bf5:0,bf6:0,bf7:0,cbf0:null==parentInjector?0:parentInjector.cbf0|parentInjector.bf0,cbf1:null==parentInjector?0:parentInjector.cbf1|parentInjector.bf1,cbf2:null==parentInjector?0:parentInjector.cbf2|parentInjector.bf2,cbf3:null==parentInjector?0:parentInjector.cbf3|parentInjector.bf3,cbf4:null==parentInjector?0:parentInjector.cbf4|parentInjector.bf4,cbf5:null==parentInjector?0:parentInjector.cbf5|parentInjector.bf5,cbf6:null==parentInjector?0:parentInjector.cbf6|parentInjector.bf6,cbf7:null==parentInjector?0:parentInjector.cbf7|parentInjector.bf7,templateRef:null,viewContainerRef:null,elementRef:null,changeDetectorRef:null}}function diPublicInInjector(di,def){!function(injector,type){var id=type[NG_ELEMENT_ID];null==id&&(id=type[NG_ELEMENT_ID]=nextNgElementId++);var bloomBit=id%BLOOM_SIZE,mask=1<<bloomBit;bloomBit<128?bloomBit<64?bloomBit<32?injector.bf0|=mask:injector.bf1|=mask:bloomBit<96?injector.bf2|=mask:injector.bf3|=mask:bloomBit<192?bloomBit<160?injector.bf4|=mask:injector.bf5|=mask:bloomBit<224?injector.bf6|=mask:injector.bf7|=mask}(di,def.type)}function diPublic(def){diPublicInInjector(getOrCreateNodeInjector(),def)}new ComponentFactoryResolver$1;function getOrCreateChangeDetectorRef(di,context){if(di.changeDetectorRef)return di.changeDetectorRef;var currentNode=di.node;return 4096==(4096&currentNode.tNode.flags)?di.changeDetectorRef=new ViewRef$1(currentNode.data,context):3===currentNode.tNode.type?di.changeDetectorRef=function(currentNode){var hostNode=function(node){for(;2===node.tNode.type;)node=node.view[HOST_NODE];return node}(currentNode),hostInjector=hostNode.nodeInjector,existingRef=hostInjector&&hostInjector.changeDetectorRef;return existingRef||new ViewRef$1(hostNode.data,hostNode.view[DIRECTIVES][hostNode.tNode.flags>>14])}(currentNode.view[HOST_NODE]):null}function getOrCreateInjectable(di,token,flags){void 0===flags&&(flags=0);var id,bloomHash="number"==typeof(id=token[NG_ELEMENT_ID])?id%BLOOM_SIZE:null;if(null===bloomHash){var formerInjector=setCurrentInjector(getPreviousOrParentNode().view[INJECTOR$1]);try{return inject(token,flags)}finally{setCurrentInjector(formerInjector)}}else for(var injector=di;injector&&(injector=bloomFindPossibleInjector(injector,bloomHash,flags));){var node=injector.node,nodeFlags=node.tNode.flags,count=4095&nodeFlags;if(0!==count)for(var start=nodeFlags>>14,end=start+count,defs=node.view[TVIEW].directives,i=start;i<end;i++){var directiveDef=defs[i];if(directiveDef.type===token&&directiveDef.diPublic)return node.view[DIRECTIVES][i]}var instance=void 0;if(injector===di&&(instance=searchMatchesQueuedForCreation(node,token)))return instance;injector=2&flags||1&flags&&!sameHostView(injector)?null:injector.parent}if(8&flags)return null;throw new Error("Injector: NOT_FOUND ["+stringify$1(token)+"]")}function searchMatchesQueuedForCreation(node,token){var matches=node.view[TVIEW].currentMatches;if(matches)for(var i=0;i<matches.length;i+=2){var def=matches[i];if(def.type===token)return resolveDirective(def,i+1,matches,node.view[TVIEW])}return null}function bloomFindPossibleInjector(startInjector,bloomBit,flags){for(var mask=1<<bloomBit,injector=4&flags?startInjector.parent:startInjector;injector;){if(((bloomBit<128?bloomBit<64?bloomBit<32?injector.bf0:injector.bf1:bloomBit<96?injector.bf2:injector.bf3:bloomBit<192?bloomBit<160?injector.bf4:injector.bf5:bloomBit<224?injector.bf6:injector.bf7)&mask)===mask)return injector;if(2&flags||1&flags&&!sameHostView(injector))return null;injector=(bloomBit<128?bloomBit<64?bloomBit<32?injector.cbf0:injector.cbf1:bloomBit<96?injector.cbf2:injector.cbf3:bloomBit<192?bloomBit<160?injector.cbf4:injector.cbf5:bloomBit<224?injector.cbf6:injector.cbf7)&mask?injector.parent:null}return null}function sameHostView(injector){return!!injector.parent&&injector.parent.node.view===injector.node.view}var ReadFromInjectorFn=function(){return function(read){this.read=read}}();function getOrCreateElementRef(di){return di.elementRef||(di.elementRef=new ElementRef$1(di.node.native))}new ReadFromInjectorFn(function(injector){return getOrCreateTemplateRef(injector)}),new ReadFromInjectorFn(function(injector){return getOrCreateContainerRef(injector)}),new ReadFromInjectorFn(function(injector){return getOrCreateElementRef(injector)}),new ReadFromInjectorFn(function(injector,node,directiveIdx){if(ngDevMode&&assertNodeOfPossibleTypes(node,0,3),directiveIdx>-1)return node.view[DIRECTIVES][directiveIdx];if(3===node.tNode.type)return getOrCreateElementRef(injector);if(0===node.tNode.type)return getOrCreateTemplateRef(injector);throw new Error("fail")});var ElementRef$1=function(){return function(nativeElement){this.nativeElement=nativeElement}}();function getOrCreateContainerRef(di){if(!di.viewContainerRef){var vcRefHost=di.node;ngDevMode&&assertNodeOfPossibleTypes(vcRefHost,0,3);var hostParent=getParentLNode(vcRefHost),lContainer=createLContainer(hostParent,vcRefHost.view,!0),comment=vcRefHost.view[RENDERER].createComment(ngDevMode?"container":""),lContainerNode=createLNodeObject(0,vcRefHost.view,hostParent,comment,lContainer,null);appendChild(hostParent,comment,vcRefHost.view),vcRefHost.queries&&(lContainerNode.queries=vcRefHost.queries.container());var hostTNode=vcRefHost.tNode;hostTNode.dynamicContainerNode||(hostTNode.dynamicContainerNode=createTNode(0,-1,null,null,hostTNode,null)),lContainerNode.tNode=hostTNode.dynamicContainerNode,vcRefHost.dynamicLContainerNode=lContainerNode,addToViewTree(vcRefHost.view,hostTNode.index,lContainer),di.viewContainerRef=new ViewContainerRef$1(lContainerNode)}return di.viewContainerRef}var ViewContainerRef$1=function(){function ViewContainerRef(_lContainerNode){this._lContainerNode=_lContainerNode,this._viewRefs=[]}return ViewContainerRef.prototype.clear=function(){for(var lContainer=this._lContainerNode.data;lContainer[VIEWS].length;)this.remove(0)},ViewContainerRef.prototype.get=function(index){return this._viewRefs[index]||null},Object.defineProperty(ViewContainerRef.prototype,"length",{get:function(){return this._lContainerNode.data[VIEWS].length},enumerable:!0,configurable:!0}),ViewContainerRef.prototype.createEmbeddedView=function(templateRef,context,index){var adjustedIdx=this._adjustIndex(index),viewRef=templateRef.createEmbeddedView(context||{},this._lContainerNode,adjustedIdx);return viewRef.attachToViewContainerRef(this),this._viewRefs.splice(adjustedIdx,0,viewRef),viewRef},ViewContainerRef.prototype.createComponent=function(componentFactory,index,injector,projectableNodes,ngModuleRef){var contextInjector=injector||this.parentInjector;!ngModuleRef&&contextInjector&&(ngModuleRef=contextInjector.get(NgModuleRef));var componentRef=componentFactory.create(contextInjector,projectableNodes,void 0,ngModuleRef);return this.insert(componentRef.hostView,index),componentRef},ViewContainerRef.prototype.insert=function(viewRef,index){if(viewRef.destroyed)throw new Error("Cannot insert a destroyed View in a ViewContainer!");var lViewNode=viewRef._lViewNode,adjustedIdx=this._adjustIndex(index);insertView(this._lContainerNode,lViewNode,adjustedIdx);var views=this._lContainerNode.data[VIEWS],beforeNode=adjustedIdx+1<views.length?getChildLNode(views[adjustedIdx+1]).native:this._lContainerNode.native;return addRemoveViewFromContainer(this._lContainerNode,lViewNode,!0,beforeNode),viewRef.attachToViewContainerRef(this),this._viewRefs.splice(adjustedIdx,0,viewRef),viewRef},ViewContainerRef.prototype.move=function(viewRef,newIndex){var index=this.indexOf(viewRef);return this.detach(index),this.insert(viewRef,this._adjustIndex(newIndex)),viewRef},ViewContainerRef.prototype.indexOf=function(viewRef){return this._viewRefs.indexOf(viewRef)},ViewContainerRef.prototype.remove=function(index){var adjustedIdx=this._adjustIndex(index,-1);removeView(this._lContainerNode,adjustedIdx),this._viewRefs.splice(adjustedIdx,1)},ViewContainerRef.prototype.detach=function(index){var adjustedIdx=this._adjustIndex(index,-1);detachView(this._lContainerNode,adjustedIdx);return this._viewRefs.splice(adjustedIdx,1)[0]||null},ViewContainerRef.prototype._adjustIndex=function(index,shift){return void 0===shift&&(shift=0),null==index?this._lContainerNode.data[VIEWS].length+shift:(ngDevMode&&(index<=-1&&throwError("index must be positive"),assertLessThan(index,this._lContainerNode.data[VIEWS].length+1+shift,"index")),index)},ViewContainerRef}();function getOrCreateTemplateRef(di){if(!di.templateRef){ngDevMode&&assertNodeType(di.node,0);var hostNode=di.node,hostTNode=hostNode.tNode;ngDevMode&&assertDefined(hostTNode.tViews,"TView must be allocated"),di.templateRef=new TemplateRef$1(getOrCreateElementRef(di),hostTNode.tViews,getRenderer(),hostNode.data[QUERIES])}return di.templateRef}var TemplateRef$1=function(){function TemplateRef(elementRef,_tView,_renderer,_queries){this._tView=_tView,this._renderer=_renderer,this._queries=_queries,this.elementRef=elementRef}return TemplateRef.prototype.createEmbeddedView=function(context,containerNode,index){var viewNode=function(tView,context,renderer,queries){var _isParent=isParent,_previousOrParentNode=previousOrParentNode;isParent=!0,previousOrParentNode=null;var lView=createLViewData(renderer,tView,context,2,getCurrentSanitizer());queries&&(lView[QUERIES]=queries.createView());var viewNode=createLNode(-1,2,null,null,null,lView);return isParent=_isParent,previousOrParentNode=_previousOrParentNode,viewNode}(this._tView,context,this._renderer,this._queries);containerNode&&insertView(containerNode,viewNode,index),renderEmbeddedTemplate(viewNode,this._tView,context,1);var viewRef=new ViewRef$1(viewNode.data,context);return viewRef._lViewNode=viewNode,viewRef},TemplateRef}();
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
var i18nTagRegex=/{\$([^}]+)}/g;function appendI18nNode(node,parentNode,previousNode){ngDevMode&&ngDevMode.rendererMoveNode++;var viewData=getViewData();appendChild(parentNode,node.native||null,viewData);var firstTemplatePass=node.view[TVIEW].firstTemplatePass;return firstTemplatePass&&(previousNode===parentNode&&node.tNode!==parentNode.tNode.child?(node.tNode.next=parentNode.tNode.child,parentNode.tNode.child=node.tNode):previousNode!==parentNode&&node.tNode!==previousNode.tNode.next?(node.tNode.next=previousNode.tNode.next,previousNode.tNode.next=node.tNode):node.tNode.next=null,parentNode.view===node.view&&(node.tNode.parent=parentNode.tNode)),0===node.tNode.type&&node.dynamicLContainerNode?(appendChild(parentNode,node.dynamicLContainerNode.native||null,viewData),firstTemplatePass&&(node.tNode.dynamicContainerNode=node.dynamicLContainerNode.tNode,node.dynamicLContainerNode.tNode.parent=node.tNode),node.dynamicLContainerNode):node}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
var COMPONENT_FACTORY_RESOLVER={provide:ComponentFactoryResolver,useFactory:function(){return new ComponentFactoryResolver$1},deps:[]},NgModuleRef$1=function(_super){function NgModuleRef$$1(ngModuleType,parentInjector){var _this=_super.call(this)||this;_this._bootstrapComponents=[],_this.destroyCbs=[];var ngModuleDef=ngModuleType.ngModuleDef;ngDevMode&&assertDefined(ngModuleDef,"NgModule '"+stringify(ngModuleType)+"' is not a subtype of 'NgModuleType'."),_this._bootstrapComponents=ngModuleDef.bootstrap;var additionalProviders=[COMPONENT_FACTORY_RESOLVER,{provide:NgModuleRef,useValue:_this}];return _this.injector=createInjector(ngModuleType,parentInjector,additionalProviders),_this.instance=_this.injector.get(ngModuleType),_this.componentFactoryResolver=new ComponentFactoryResolver$1,_this}return __extends(NgModuleRef$$1,_super),NgModuleRef$$1.prototype.destroy=function(){ngDevMode&&assertDefined(this.destroyCbs,"NgModule already destroyed"),this.destroyCbs.forEach(function(fn){return fn()}),this.destroyCbs=null},NgModuleRef$$1.prototype.onDestroy=function(callback){ngDevMode&&assertDefined(this.destroyCbs,"NgModule already destroyed"),this.destroyCbs.push(callback)},NgModuleRef$$1}(NgModuleRef),NgModuleFactory$1=function(_super){function NgModuleFactory$$1(moduleType){var _this=_super.call(this)||this;return _this.moduleType=moduleType,_this}return __extends(NgModuleFactory$$1,_super),NgModuleFactory$$1.prototype.create=function(parentInjector){return new NgModuleRef$1(this.moduleType,parentInjector)},NgModuleFactory$$1}(NgModuleFactory);function pureFunction1(slotOffset,pureFn,exp,thisArg){ngDevMode&&assertReservedSlotInitialized(slotOffset,2);var index=moveBindingIndexToReservedSlot(slotOffset),value=bindingUpdated(exp)?checkAndUpdateBinding$1(thisArg?pureFn.call(thisArg,exp):pureFn(exp)):consumeBinding();return restoreBindingIndex(index),value}function pureFunction2(slotOffset,pureFn,exp1,exp2,thisArg){ngDevMode&&assertReservedSlotInitialized(slotOffset,3);var index=moveBindingIndexToReservedSlot(slotOffset),value=bindingUpdated2(exp1,exp2)?checkAndUpdateBinding$1(thisArg?pureFn.call(thisArg,exp1,exp2):pureFn(exp1,exp2)):consumeBinding();return restoreBindingIndex(index),value}function pureFunction3(slotOffset,pureFn,exp1,exp2,exp3,thisArg){ngDevMode&&assertReservedSlotInitialized(slotOffset,4);var index=moveBindingIndexToReservedSlot(slotOffset),different=bindingUpdated2(exp1,exp2),value=bindingUpdated(exp3)||different?checkAndUpdateBinding$1(thisArg?pureFn.call(thisArg,exp1,exp2,exp3):pureFn(exp1,exp2,exp3)):consumeBinding();return restoreBindingIndex(index),value}function pureFunction4(slotOffset,pureFn,exp1,exp2,exp3,exp4,thisArg){ngDevMode&&assertReservedSlotInitialized(slotOffset,5);var index=moveBindingIndexToReservedSlot(slotOffset),value=bindingUpdated4(exp1,exp2,exp3,exp4)?checkAndUpdateBinding$1(thisArg?pureFn.call(thisArg,exp1,exp2,exp3,exp4):pureFn(exp1,exp2,exp3,exp4)):consumeBinding();return restoreBindingIndex(index),value}function pureFunctionV(slotOffset,pureFn,exps,thisArg){ngDevMode&&assertReservedSlotInitialized(slotOffset,exps.length+1);for(var index=moveBindingIndexToReservedSlot(slotOffset),different=!1,i=0;i<exps.length;i++)bindingUpdated(exps[i])&&(different=!0);var value=different?checkAndUpdateBinding$1(pureFn.apply(thisArg,exps)):consumeBinding();return restoreBindingIndex(index),value}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function isPure(index){return getTView().data[index+HEADER_OFFSET].pure}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function(componentType,opts){void 0===opts&&(opts={}),ngDevMode&&assertComponentType(componentType);var component,rendererFactory=opts.rendererFactory||domRendererFactory3,sanitizer=opts.sanitizer||null,componentDef=componentType.ngComponentDef;componentDef.type!=componentType&&(componentDef.type=componentType);var componentTag=componentDef.selectors[0][0],hostNode=locateHostElement(rendererFactory,opts.host||componentTag),rootContext=createRootContext(opts.scheduler||requestAnimationFrame.bind(window)),rootView=createLViewData(rendererFactory.createRenderer(hostNode,componentDef.rendererType),createTView(-1,null,null,null,null),rootContext,componentDef.onPush?4:2);rootView[INJECTOR$1]=opts.injector||null;var elementNode,oldView=enterView(rootView,null);try{rendererFactory.begin&&rendererFactory.begin(),elementNode=hostElement(0,hostNode,componentDef,sanitizer),rootContext.components.push(component=baseDirectiveCreate(0,componentDef.factory(),componentDef)),initChangeDetectorIfExisting(elementNode.nodeInjector,component,elementNode.data),opts.hostFeatures&&opts.hostFeatures.forEach(function(feature){return feature(component,componentDef)}),executeInitAndContentHooks(),setHostBindings(ROOT_DIRECTIVE_INDICES),detectChangesInternal(elementNode.data,elementNode,component)}finally{leaveView(oldView),rendererFactory.end&&rendererFactory.end()}return component},exports.ɵdirectiveInject=function(token,flags){return void 0===flags&&(flags=0),getOrCreateInjectable(getOrCreateNodeInjector(),token,flags)},exports.ɵinjectElementRef=function(){return getOrCreateElementRef(getOrCreateNodeInjector())},exports.ɵinjectTemplateRef=function(){return getOrCreateTemplateRef(getOrCreateNodeInjector())},exports.ɵinjectViewContainerRef=function(){return getOrCreateContainerRef(getOrCreateNodeInjector())},exports.ɵinjectChangeDetectorRef=function(){return getOrCreateChangeDetectorRef(getOrCreateNodeInjector(),null)},exports.ɵinjectAttribute=function(attrNameToInject){ngDevMode&&assertPreviousIsParent();var lElement=getPreviousOrParentNode();ngDevMode&&assertNodeType(lElement,3);var tElement=lElement.tNode;ngDevMode&&assertDefined(tElement,"expecting tNode");var attrs=tElement.attrs;if(attrs)for(var i=0;i<attrs.length;i+=2){var attrName=attrs[i];if(1===attrName)break;if(attrName==attrNameToInject)return attrs[i+1]}},exports.ɵPublicFeature=function(definition){definition.diPublic=diPublic},exports.ɵInheritDefinitionFeature=function InheritDefinitionFeature(definition){for(var type,superType=(type=definition.type,Object.getPrototypeOf(type.prototype).constructor),superDef=void 0,_loop_1=function(){if(function(definition){return"function"==typeof definition.template}(definition))superDef=superType.ngComponentDef||superType.ngDirectiveDef;else{if(superType.ngComponentDef)throw new Error("Directives cannot inherit Components");superDef=superType.ngDirectiveDef}if(superDef){fillProperties(definition.inputs,superDef.inputs),fillProperties(definition.declaredInputs,superDef.declaredInputs),fillProperties(definition.outputs,superDef.outputs);var prevHostBindings_1=definition.hostBindings,superHostBindings_1=superDef.hostBindings;superHostBindings_1&&(definition.hostBindings=prevHostBindings_1?function(directiveIndex,elementIndex){superHostBindings_1(directiveIndex,elementIndex),prevHostBindings_1(directiveIndex,elementIndex)}:superHostBindings_1),definition.afterContentChecked=definition.afterContentChecked||superDef.afterContentChecked,definition.afterContentInit=definition.afterContentInit||superDef.afterContentInit,definition.afterViewChecked=definition.afterViewChecked||superDef.afterViewChecked,definition.afterViewInit=definition.afterViewInit||superDef.afterViewInit,definition.doCheck=definition.doCheck||superDef.doCheck,definition.onDestroy=definition.onDestroy||superDef.onDestroy,definition.onInit=definition.onInit||superDef.onInit;var features=superDef.features;if(features)for(var _i=0,features_1=features;_i<features_1.length;_i++){var feature=features_1[_i];feature&&feature!==InheritDefinitionFeature&&feature(definition)}}else{var superPrototype=superType.prototype;superPrototype&&(definition.afterContentChecked=definition.afterContentChecked||superPrototype.afterContentChecked,definition.afterContentInit=definition.afterContentInit||superPrototype.afterContentInit,definition.afterViewChecked=definition.afterViewChecked||superPrototype.afterViewChecked,definition.afterViewInit=definition.afterViewInit||superPrototype.afterViewInit,definition.doCheck=definition.doCheck||superPrototype.doCheck,definition.onDestroy=definition.onDestroy||superPrototype.onDestroy,definition.onInit=definition.onInit||superPrototype.onInit)}superType=Object.getPrototypeOf(superType)};superType&&!superDef;)_loop_1()},exports.ɵNgOnChangesFeature=function(definition){var declaredToMinifiedInputs=definition.declaredInputs,proto=definition.type.prototype,_loop_1=function(declaredName){if(declaredToMinifiedInputs.hasOwnProperty(declaredName)){for(var minifiedKey=declaredToMinifiedInputs[declaredName],privateMinKey_1=PRIVATE_PREFIX+minifiedKey,originalProperty=void 0,checkProto=proto;!originalProperty&&checkProto&&Object.getPrototypeOf(checkProto)!==Object.getPrototypeOf(Object.prototype);)originalProperty=Object.getOwnPropertyDescriptor(checkProto,minifiedKey),checkProto=Object.getPrototypeOf(checkProto);var getter=originalProperty&&originalProperty.get,setter_1=originalProperty&&originalProperty.set;Object.defineProperty(proto,minifiedKey,{get:getter||(setter_1?void 0:function(){return this[privateMinKey_1]}),set:function(value){var simpleChanges=this[PRIVATE_PREFIX];simpleChanges||(simpleChanges={},Object.defineProperty(this,PRIVATE_PREFIX,{value:simpleChanges,writable:!0}));var isFirstChange=!this.hasOwnProperty(privateMinKey_1),currentChange=simpleChanges[declaredName];currentChange?currentChange.currentValue=value:simpleChanges[declaredName]=new SimpleChange(this[privateMinKey_1],value,isFirstChange),isFirstChange?Object.defineProperty(this,privateMinKey_1,{value:value,writable:!0}):this[privateMinKey_1]=value,setter_1&&setter_1.call(this,value)}})}};for(var declaredName in declaredToMinifiedInputs)_loop_1(declaredName);null!=definition.onInit&&(definition.onInit=onChangesWrapper(definition.onInit)),definition.doCheck=onChangesWrapper(definition.doCheck)},exports.ɵmarkDirty=function(component){ngDevMode&&assertDefined(component,"component"),markViewDirty(_getComponentHostLElementNode(component).view)},exports.ɵNgModuleFactory=NgModuleFactory$1,exports.ɵNC=NO_CHANGE,exports.ɵC=function(index,template,tagName,attrs,localRefs){ngDevMode&&assertEqual(viewData[BINDING_INDEX],-1,"container nodes should be created before any bindings");var lContainer=createLContainer(isParent?previousOrParentNode:getParentLNode(previousOrParentNode),viewData),comment=renderer.createComment(ngDevMode?"container":""),node=createLNode(index,0,comment,tagName||null,attrs||null,lContainer);appendChild(getParentLNode(node),comment,viewData),firstTemplatePass&&(node.tNode.tViews=template?createTView(-1,template,tView.directiveRegistry,tView.pipeRegistry,null):[]),addToViewTree(viewData,index+HEADER_OFFSET,node.data);var queries=node.queries;queries&&(lContainer[QUERIES]=queries.container()),createDirectivesAndLocals(localRefs),isParent=!1,ngDevMode&&assertNodeType(previousOrParentNode,0),queries&&queries.addNode(node),queueLifecycleHooks(node.tNode.flags,tView)},exports.ɵE=elementStart,exports.ɵNH=namespaceHTML,exports.ɵNM=function(){_currentNamespace="http://www.w3.org/1998/MathML/"},exports.ɵNS=function(){_currentNamespace="http://www.w3.org/2000/svg/"},exports.ɵEe=function(index,name,attrs,localRefs){elementStart(index,name,attrs,localRefs),elementEnd()},exports.ɵL=function(eventName,listenerFn,useCapture){void 0===useCapture&&(useCapture=!1),ngDevMode&&assertPreviousIsParent();var node=previousOrParentNode,native=node.native;if(ngDevMode&&ngDevMode.rendererAddEventListener++,isProceduralRenderer(renderer)){var wrappedListener=function(view,listenerFn){return function(e){return markViewDirty(view),listenerFn(e)}}(viewData,listenerFn),cleanupFn=renderer.listen(native,eventName,wrappedListener);storeCleanupFn(viewData,cleanupFn)}else{wrappedListener=function(view,listenerFn){return function(e){markViewDirty(view),!1===listenerFn(e)&&(e.preventDefault(),e.returnValue=!1)}}(viewData,listenerFn),native.addEventListener(eventName,wrappedListener,useCapture);var cleanupInstances=getCleanup(viewData);cleanupInstances.push(wrappedListener),firstTemplatePass&&getTViewCleanup(viewData).push(eventName,node.tNode.index,cleanupInstances.length-1,useCapture)}var tNode=node.tNode;void 0===tNode.outputs&&(tNode.outputs=generatePropertyAliases(node.tNode.flags,1));var outputData,outputs=tNode.outputs;outputs&&(outputData=outputs[eventName])&&function(outputs,listener){for(var i=0;i<outputs.length;i+=2){ngDevMode&&assertDataInRange(outputs[i],directives);var subscription=directives[outputs[i]][outputs[i+1]].subscribe(listener);storeCleanupWithContext(viewData,subscription,subscription.unsubscribe)}}(outputData,listenerFn)},exports.ɵT=function(index,value){ngDevMode&&assertEqual(viewData[BINDING_INDEX],-1,"text nodes should be created before bindings"),ngDevMode&&ngDevMode.rendererCreateTextNode++;var textNode=createTextNode(value,renderer),node=createLNode(index,3,textNode,null,null);isParent=!1,appendChild(getParentLNode(node),textNode,viewData)},exports.ɵV=function(viewBlockId){var container=isParent?previousOrParentNode:getParentLNode(previousOrParentNode);ngDevMode&&assertNodeType(container,0);var lContainer=container.data,viewNode=function(containerNode,startIdx,viewBlockId){for(var views=containerNode.data[VIEWS],i=startIdx;i<views.length;i++){var viewAtPositionId=views[i].data[TVIEW].id;if(viewAtPositionId===viewBlockId)return views[i];if(!(viewAtPositionId<viewBlockId))break;removeView(containerNode,i)}return null}(container,lContainer[ACTIVE_INDEX],viewBlockId);if(viewNode)previousOrParentNode=viewNode,ngDevMode&&assertNodeType(previousOrParentNode,2),isParent=!0,enterView(viewNode.data,viewNode);else{var newView=createLViewData(renderer,function(viewIndex,parent){ngDevMode&&assertNodeType(parent,0);var containerTViews=parent.tNode.tViews;return ngDevMode&&assertDefined(containerTViews,"TView expected"),ngDevMode&&assertEqual(Array.isArray(containerTViews),!0,"TViews should be in an array"),(viewIndex>=containerTViews.length||null==containerTViews[viewIndex])&&(containerTViews[viewIndex]=createTView(viewIndex,null,tView.directiveRegistry,tView.pipeRegistry,null)),containerTViews[viewIndex]}(viewBlockId,container),null,2,getCurrentSanitizer());lContainer[QUERIES]&&(newView[QUERIES]=lContainer[QUERIES].createView()),enterView(newView,viewNode=createLNode(viewBlockId,2,null,null,null,newView))}return container&&(creationMode&&insertView(container,viewNode,lContainer[ACTIVE_INDEX]),lContainer[ACTIVE_INDEX]++),getRenderFlags(viewNode.data)},exports.ɵQ=function(memoryIndex,predicate,descend,read){ngDevMode&&assertPreviousIsParent();var QueryType,queryList=new QueryList$1;return(QueryType=LQueries_,currentQueries||(currentQueries=previousOrParentNode.queries&&previousOrParentNode.queries.clone()||new QueryType)).track(queryList,predicate,descend,read),storeCleanupWithContext(null,queryList,queryList.destroy),null!=memoryIndex&&store(memoryIndex,queryList),queryList},exports.ɵQr=function(queryList){var savedContentQueriesLength=(viewData[CONTENT_QUERIES]||(viewData[CONTENT_QUERIES]=[])).push(queryList);if(firstTemplatePass){var currentDirectiveIndex=directives.length-1,tViewContentQueries=tView.contentQueries||(tView.contentQueries=[]);currentDirectiveIndex!==(tView.contentQueries.length?tView.contentQueries[tView.contentQueries.length-2]:-1)&&tViewContentQueries.push(currentDirectiveIndex,savedContentQueriesLength-1)}},exports.ɵd=function(index){return ngDevMode&&assertDefined(directives,"Directives array should be defined if reading a dir."),ngDevMode&&assertDataInRange(index,directives),directives[index]},exports.ɵP=function(nodeIndex,selectorIndex,attrs){void 0===selectorIndex&&(selectorIndex=0);var node=createLNode(nodeIndex,1,null,null,attrs||null,null);null===node.tNode.projection&&(node.tNode.projection=selectorIndex),isParent=!1;var parent=getParentLNode(node);if(canInsertNativeNode(parent,viewData))for(var componentNode=findComponentHost(viewData),nodeToProject=componentNode.tNode.projection[selectorIndex],projectedView=componentNode.view,projectionNodeIndex=-1,grandparent=void 0,renderParent=2===parent.tNode.type?(grandparent=getParentLNode(parent))&&grandparent.data[RENDER_PARENT]:parent;nodeToProject;){if(1===nodeToProject.type){var currentComponentHost=findComponentHost(projectedView),firstProjectedNode=currentComponentHost.tNode.projection[nodeToProject.projection];if(firstProjectedNode){projectionNodeStack[++projectionNodeIndex]=projectedView[nodeToProject.index],nodeToProject=firstProjectedNode,projectedView=currentComponentHost.view;continue}}else(lNode=projectedView[nodeToProject.index]).tNode.flags|=8192,appendProjectedNode(lNode,parent,viewData,renderParent);var lNode;null===nodeToProject.next&&projectedView!==componentNode.view&&(nodeToProject=(lNode=projectionNodeStack[projectionNodeIndex--]).tNode,projectedView=lNode.view),nodeToProject=nodeToProject.next}},exports.ɵb=function(value){return bindingUpdated(value)?value:NO_CHANGE},exports.ɵi1=function(prefix,v0,suffix){return bindingUpdated(v0)?prefix+stringify$1(v0)+suffix:NO_CHANGE},exports.ɵi2=function(prefix,v0,i0,v1,suffix){return bindingUpdated2(v0,v1)?prefix+stringify$1(v0)+i0+stringify$1(v1)+suffix:NO_CHANGE},exports.ɵi3=function(prefix,v0,i0,v1,i1,v2,suffix){var different=bindingUpdated2(v0,v1);return(different=bindingUpdated(v2)||different)?prefix+stringify$1(v0)+i0+stringify$1(v1)+i1+stringify$1(v2)+suffix:NO_CHANGE},exports.ɵi4=function(prefix,v0,i0,v1,i1,v2,i2,v3,suffix){return bindingUpdated4(v0,v1,v2,v3)?prefix+stringify$1(v0)+i0+stringify$1(v1)+i1+stringify$1(v2)+i2+stringify$1(v3)+suffix:NO_CHANGE},exports.ɵi5=function(prefix,v0,i0,v1,i1,v2,i2,v3,i3,v4,suffix){var different=bindingUpdated4(v0,v1,v2,v3);return(different=bindingUpdated(v4)||different)?prefix+stringify$1(v0)+i0+stringify$1(v1)+i1+stringify$1(v2)+i2+stringify$1(v3)+i3+stringify$1(v4)+suffix:NO_CHANGE},exports.ɵi6=function(prefix,v0,i0,v1,i1,v2,i2,v3,i3,v4,i4,v5,suffix){var different=bindingUpdated4(v0,v1,v2,v3);return(different=bindingUpdated2(v4,v5)||different)?prefix+stringify$1(v0)+i0+stringify$1(v1)+i1+stringify$1(v2)+i2+stringify$1(v3)+i3+stringify$1(v4)+i4+stringify$1(v5)+suffix:NO_CHANGE},exports.ɵi7=function(prefix,v0,i0,v1,i1,v2,i2,v3,i3,v4,i4,v5,i5,v6,suffix){var different=bindingUpdated4(v0,v1,v2,v3);return different=bindingUpdated2(v4,v5)||different,(different=bindingUpdated(v6)||different)?prefix+stringify$1(v0)+i0+stringify$1(v1)+i1+stringify$1(v2)+i2+stringify$1(v3)+i3+stringify$1(v4)+i4+stringify$1(v5)+i5+stringify$1(v6)+suffix:NO_CHANGE},exports.ɵi8=function(prefix,v0,i0,v1,i1,v2,i2,v3,i3,v4,i4,v5,i5,v6,i6,v7,suffix){var different=bindingUpdated4(v0,v1,v2,v3);return(different=bindingUpdated4(v4,v5,v6,v7)||different)?prefix+stringify$1(v0)+i0+stringify$1(v1)+i1+stringify$1(v2)+i2+stringify$1(v3)+i3+stringify$1(v4)+i4+stringify$1(v5)+i5+stringify$1(v6)+i6+stringify$1(v7)+suffix:NO_CHANGE},exports.ɵiV=function(values){ngDevMode&&assertLessThan(2,values.length,"should have at least 3 values"),ngDevMode&&assertEqual(values.length%2,1,"should have an odd number of values");for(var different=!1,i=1;i<values.length;i+=2)bindingUpdated(values[i])&&(different=!0);if(!different)return NO_CHANGE;var content=values[0];for(i=1;i<values.length;i+=2)content+=stringify$1(values[i])+values[i+1];return content},exports.ɵpb1=function(index,slotOffset,v1){var pipeInstance=load(index);return isPure(index)?pureFunction1(slotOffset,pipeInstance.transform,v1,pipeInstance):pipeInstance.transform(v1)},exports.ɵpb2=function(index,slotOffset,v1,v2){var pipeInstance=load(index);return isPure(index)?pureFunction2(slotOffset,pipeInstance.transform,v1,v2,pipeInstance):pipeInstance.transform(v1,v2)},exports.ɵpb3=function(index,slotOffset,v1,v2,v3){var pipeInstance=load(index);return isPure(index)?pureFunction3(slotOffset,pipeInstance.transform,v1,v2,v3,pipeInstance):pipeInstance.transform(v1,v2,v3)},exports.ɵpb4=function(index,slotOffset,v1,v2,v3,v4){var pipeInstance=load(index);return isPure(index)?pureFunction4(slotOffset,pipeInstance.transform,v1,v2,v3,v4,pipeInstance):pipeInstance.transform(v1,v2,v3,v4)},exports.ɵpbV=function(index,slotOffset,values){var pipeInstance=load(index);return isPure(index)?pureFunctionV(slotOffset,pipeInstance.transform,values,pipeInstance):pipeInstance.transform.apply(pipeInstance,values)},exports.ɵf0=
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function(slotOffset,pureFn,thisArg){ngDevMode&&assertReservedSlotInitialized(slotOffset,1);var index=moveBindingIndexToReservedSlot(slotOffset),value=creationMode?checkAndUpdateBinding$1(thisArg?pureFn.call(thisArg):pureFn()):consumeBinding();return restoreBindingIndex(index),value},exports.ɵf1=pureFunction1,exports.ɵf2=pureFunction2,exports.ɵf3=pureFunction3,exports.ɵf4=pureFunction4,exports.ɵf5=function(slotOffset,pureFn,exp1,exp2,exp3,exp4,exp5,thisArg){ngDevMode&&assertReservedSlotInitialized(slotOffset,6);var index=moveBindingIndexToReservedSlot(slotOffset),different=bindingUpdated4(exp1,exp2,exp3,exp4),value=bindingUpdated(exp5)||different?checkAndUpdateBinding$1(thisArg?pureFn.call(thisArg,exp1,exp2,exp3,exp4,exp5):pureFn(exp1,exp2,exp3,exp4,exp5)):consumeBinding();return restoreBindingIndex(index),value},exports.ɵf6=function(slotOffset,pureFn,exp1,exp2,exp3,exp4,exp5,exp6,thisArg){ngDevMode&&assertReservedSlotInitialized(slotOffset,7);var index=moveBindingIndexToReservedSlot(slotOffset),different=bindingUpdated4(exp1,exp2,exp3,exp4),value=bindingUpdated2(exp5,exp6)||different?checkAndUpdateBinding$1(thisArg?pureFn.call(thisArg,exp1,exp2,exp3,exp4,exp5,exp6):pureFn(exp1,exp2,exp3,exp4,exp5,exp6)):consumeBinding();return restoreBindingIndex(index),value},exports.ɵf7=function(slotOffset,pureFn,exp1,exp2,exp3,exp4,exp5,exp6,exp7,thisArg){ngDevMode&&assertReservedSlotInitialized(slotOffset,8);var index=moveBindingIndexToReservedSlot(slotOffset),different=bindingUpdated4(exp1,exp2,exp3,exp4);different=bindingUpdated2(exp5,exp6)||different;var value=bindingUpdated(exp7)||different?checkAndUpdateBinding$1(thisArg?pureFn.call(thisArg,exp1,exp2,exp3,exp4,exp5,exp6,exp7):pureFn(exp1,exp2,exp3,exp4,exp5,exp6,exp7)):consumeBinding();return restoreBindingIndex(index),value},exports.ɵf8=function(slotOffset,pureFn,exp1,exp2,exp3,exp4,exp5,exp6,exp7,exp8,thisArg){ngDevMode&&assertReservedSlotInitialized(slotOffset,9);var index=moveBindingIndexToReservedSlot(slotOffset),different=bindingUpdated4(exp1,exp2,exp3,exp4),value=bindingUpdated4(exp5,exp6,exp7,exp8)||different?checkAndUpdateBinding$1(thisArg?pureFn.call(thisArg,exp1,exp2,exp3,exp4,exp5,exp6,exp7,exp8):pureFn(exp1,exp2,exp3,exp4,exp5,exp6,exp7,exp8)):consumeBinding();return restoreBindingIndex(index),value},exports.ɵfV=pureFunctionV,exports.ɵcR=function(index){previousOrParentNode=loadElement(index),ngDevMode&&assertNodeType(previousOrParentNode,0),isParent=!0,previousOrParentNode.data[ACTIVE_INDEX]=0,checkNoChangesMode||executeInitHooks(viewData,tView,creationMode)},exports.ɵcr=function(){isParent?isParent=!1:(ngDevMode&&assertNodeType(previousOrParentNode,2),ngDevMode&&assertHasParent(),previousOrParentNode=getParentLNode(previousOrParentNode)),ngDevMode&&assertNodeType(previousOrParentNode,0);var container=previousOrParentNode;ngDevMode&&assertNodeType(container,0);for(var nextIndex=container.data[ACTIVE_INDEX];nextIndex<container.data[VIEWS].length;)removeView(container,nextIndex)},exports.ɵqR=function(queryList){var queryListImpl=queryList;return!!queryList.dirty&&(queryList.reset(queryListImpl._valuesTree),queryList.notifyOnChanges(),!0)},exports.ɵql=function(queryListIdx){return ngDevMode&&assertDefined(viewData[CONTENT_QUERIES],"Content QueryList array should be defined if reading a query."),ngDevMode&&assertDataInRange(queryListIdx,viewData[CONTENT_QUERIES]),viewData[CONTENT_QUERIES][queryListIdx]},exports.ɵe=elementEnd,exports.ɵp=function(index,propName,value,sanitizer){if(value!==NO_CHANGE){var node=loadElement(index),tNode=node.tNode;tNode&&void 0===tNode.inputs&&(tNode.inputs=generatePropertyAliases(node.tNode.flags,0));var dataValue,inputData=tNode&&tNode.inputs;if(inputData&&(dataValue=inputData[propName]))!function(inputs,value){for(var i=0;i<inputs.length;i+=2)ngDevMode&&assertDataInRange(inputs[i],directives),directives[inputs[i]][inputs[i+1]]=value}(dataValue,value),function(node){!node.data||2&node.data[FLAGS]||(node.data[FLAGS]|=4)}(node);else{value=null!=sanitizer?sanitizer(value):value;var native=node.native;ngDevMode&&ngDevMode.rendererSetProperty++,isProceduralRenderer(renderer)?renderer.setProperty(native,propName,value):native.setProperty?native.setProperty(propName,value):native[propName]=value}}},exports.ɵpD=function(selectors,textSelectors){var componentNode=findComponentHost(viewData);if(!componentNode.tNode.projection)for(var noOfNodeBuckets=selectors?selectors.length+1:1,pData=componentNode.tNode.projection=new Array(noOfNodeBuckets).fill(null),tails=pData.slice(),componentChild=componentNode.tNode.child;null!==componentChild;){var bucketIndex=selectors?matchingSelectorIndex(componentChild,selectors,textSelectors):0,nextNode=componentChild.next;tails[bucketIndex]?tails[bucketIndex].next=componentChild:(pData[bucketIndex]=componentChild,componentChild.next=null),tails[bucketIndex]=componentChild,componentChild=nextNode}},exports.ɵrS=function(numSlots){viewData.length+=numSlots,viewData.fill(NO_CHANGE,-numSlots),initBindings()},exports.ɵa=function(index,name,value,sanitizer){if(value!==NO_CHANGE){var element_1=loadElement(index);if(null==value)ngDevMode&&ngDevMode.rendererRemoveAttribute++,isProceduralRenderer(renderer)?renderer.removeAttribute(element_1.native,name):element_1.native.removeAttribute(name);else{ngDevMode&&ngDevMode.rendererSetAttribute++;var strValue=null==sanitizer?stringify$1(value):sanitizer(value);isProceduralRenderer(renderer)?renderer.setAttribute(element_1.native,name,strValue):element_1.native.setAttribute(name,strValue)}}},exports.ɵs=function(classDeclarations,styleDeclarations,styleSanitizer){var tNode=currentElementNode.tNode;tNode.stylingTemplate||(tNode.stylingTemplate=function(initialClassDeclarations,initialStyleDeclarations,styleSanitizer){var initialStylingValues=[null],context=[null,styleSanitizer||null,initialStylingValues,0,0,null],stylesLookup={},classesLookup={},totalStyleDeclarations=0;if(initialStyleDeclarations)for(var hasPassedDeclarations=!1,i=0;i<initialStyleDeclarations.length;i++)if(1===(v=initialStyleDeclarations[i]))hasPassedDeclarations=!0;else{var prop=v;if(hasPassedDeclarations){var value=initialStyleDeclarations[++i];initialStylingValues.push(value),stylesLookup[prop]=initialStylingValues.length-1}else totalStyleDeclarations++,stylesLookup[prop]=0}if(context[4]=totalStyleDeclarations,initialClassDeclarations)for(hasPassedDeclarations=!1,i=0;i<initialClassDeclarations.length;i++){var v;if(1===(v=initialClassDeclarations[i]))hasPassedDeclarations=!0;else{var className=v;hasPassedDeclarations?(value=initialClassDeclarations[++i],initialStylingValues.push(value),classesLookup[className]=initialStylingValues.length-1):classesLookup[className]=0}}var styleProps=Object.keys(stylesLookup),classNames=Object.keys(classesLookup),classNamesIndexStart=styleProps.length,totalProps=styleProps.length+classNames.length,maxLength=3*totalProps*2+6;for(i=6;i<maxLength;i++)context.push(null);var multiStart=3*totalProps+6;for(i=0;i<totalProps;i++){var isClassBased_1=i>=classNamesIndexStart,indexForInitial=(prop=isClassBased_1?classNames[i-classNamesIndexStart]:styleProps[i],isClassBased_1?classesLookup[prop]:stylesLookup[prop]),initialValue=initialStylingValues[indexForInitial],indexForMulti=3*i+multiStart,indexForSingle=3*i+6,initialFlag=prepareInitialFlag(prop,isClassBased_1,styleSanitizer||null);setFlag(context,indexForSingle,pointers(initialFlag,indexForInitial,indexForMulti)),setProp(context,indexForSingle,prop),setValue(context,indexForSingle,null),setFlag(context,indexForMulti,pointers(initialFlag|(null!==initialValue?1:0),indexForInitial,indexForSingle)),setProp(context,indexForMulti,prop),setValue(context,indexForMulti,null)}return setFlag(context,3,pointers(0,0,multiStart)),setContextDirty(context,initialStylingValues.length>1),context}(classDeclarations,styleDeclarations,styleSanitizer)),(styleDeclarations&&styleDeclarations.length||classDeclarations&&classDeclarations.length)&&elementStylingApply(tNode.index-HEADER_OFFSET)},exports.ɵsm=function(index,classes,styles){!function(context,classes,styles){var classNames=EMPTY_ARR,applyAllClasses=!1,ignoreAllClassUpdates=!1;if("string"==typeof classes){var cachedClassString=context[5];cachedClassString&&cachedClassString===classes?ignoreAllClassUpdates=!0:(context[5]=classes,classNames=classes.split(/\s+/),applyAllClasses=!0)}else classNames=classes?Object.keys(classes):EMPTY_ARR,context[5]=null;classes=classes||EMPTY_OBJ;var styleProps=styles?Object.keys(styles):EMPTY_ARR;styles=styles||EMPTY_OBJ;for(var classesStartIndex=styleProps.length,dirty=!1,ctxIndex=getMultiStartIndex(context),propIndex=0,propLimit=styleProps.length+classNames.length;ctxIndex<context.length&&propIndex<propLimit;){var isClassBased_2=propIndex>=classesStartIndex;if(!ignoreAllClassUpdates||!isClassBased_2){var adjustedPropIndex=isClassBased_2?propIndex-classesStartIndex:propIndex,newProp=isClassBased_2?classNames[adjustedPropIndex]:styleProps[adjustedPropIndex],newValue=isClassBased_2?!!applyAllClasses||classes[newProp]:styles[newProp];if((prop=getProp(context,ctxIndex))===newProp){var value=getValue(context,ctxIndex);hasValueChanged(flag=getPointers(context,ctxIndex),value,newValue)&&(setValue(context,ctxIndex,newValue),(initialValue=getInitialValue(context,flag))!==newValue&&(setDirty(context,ctxIndex,!0),dirty=!0))}else{var indexOfEntry=findEntryPositionByProp(context,newProp,ctxIndex);if(indexOfEntry>0){var valueToCompare=getValue(context,indexOfEntry),flagToCompare=getPointers(context,indexOfEntry);if(swapMultiContextEntries(context,ctxIndex,indexOfEntry),valueToCompare!==newValue){var initialValue=getInitialValue(context,flagToCompare);setValue(context,ctxIndex,newValue),initialValue!==newValue&&(setDirty(context,ctxIndex,!0),dirty=!0)}}else insertNewMultiProperty(context,ctxIndex,isClassBased_2,newProp,prepareInitialFlag(newProp,isClassBased_2,getStyleSanitizer(context)),newValue),dirty=!0}}ctxIndex+=3,propIndex++}for(;ctxIndex<context.length;){var isClassBased_3=2==(2&(flag=getPointers(context,ctxIndex)));if(ignoreAllClassUpdates&&isClassBased_3)break;valueExists(value=getValue(context,ctxIndex),isClassBased_3)&&(setDirty(context,ctxIndex,!0),setValue(context,ctxIndex,null),dirty=!0),ctxIndex+=3}for(var sanitizer=getStyleSanitizer(context);propIndex<propLimit;){var isClassBased_4=propIndex>=classesStartIndex;if(ignoreAllClassUpdates&&isClassBased_4)break;adjustedPropIndex=isClassBased_4?propIndex-classesStartIndex:propIndex;var prop=isClassBased_4?classNames[adjustedPropIndex]:styleProps[adjustedPropIndex],flag=(value=isClassBased_4?!!applyAllClasses||classes[prop]:styles[prop],1|prepareInitialFlag(prop,isClassBased_4,sanitizer));context.push(flag,prop,value),propIndex++,dirty=!0}dirty&&setContextDirty(context,!0)}(getStylingContext(index),classes,styles)},exports.ɵsp=function(index,styleIndex,value,suffix){var valueToAdd=null;value&&(valueToAdd=suffix?stringify$1(value)+suffix:value),updateStyleProp(getStylingContext(index),styleIndex,valueToAdd)},exports.ɵsa=elementStylingApply,exports.ɵcp=function(index,stylingIndex,value){!function(context,index,addOrRemove){updateStyleProp(context,index+context[4],addOrRemove)}(getStylingContext(index),stylingIndex,!!value)},exports.ɵt=function(index,value){if(value!==NO_CHANGE){ngDevMode&&assertDataInRange(index+HEADER_OFFSET);var existingNode=loadElement(index);ngDevMode&&assertDefined(existingNode,"LNode should exist"),ngDevMode&&assertDefined(existingNode.native,"native element should exist"),ngDevMode&&ngDevMode.rendererSetText++,isProceduralRenderer(renderer)?renderer.setValue(existingNode.native,stringify$1(value)):existingNode.native.textContent=stringify$1(value)}},exports.ɵv=function(){refreshView(),isParent=!1,previousOrParentNode=viewData[HOST_NODE],leaveView(viewData[PARENT]),ngDevMode&&assertEqual(isParent,!1,"isParent"),ngDevMode&&assertNodeType(previousOrParentNode,2)},exports.ɵst=store,exports.ɵld=load,exports.ɵPp=function(index,pipeName){var pipeDef,tView=getTView(),adjustedIndex=index+HEADER_OFFSET;tView.firstTemplatePass?(pipeDef=function(name,registry){if(registry)for(var i=0;i<registry.length;i++){var pipeDef=registry[i];if(name===pipeDef.name)return pipeDef}throw new Error("Pipe with name '"+name+"' not found!")}(pipeName,tView.pipeRegistry),tView.data[adjustedIndex]=pipeDef,pipeDef.onDestroy&&(tView.pipeDestroyHooks||(tView.pipeDestroyHooks=[])).push(adjustedIndex,pipeDef.onDestroy)):pipeDef=tView.data[adjustedIndex];var pipeInstance=pipeDef.factory();return store(index,pipeInstance),pipeInstance},exports.ɵwhenRendered=function(component){return function(component){var rootContext=getRootView(component)[CONTEXT];return ngDevMode&&assertDefined(rootContext,"rootContext"),rootContext}(component).clean},exports.ɵiA=function(startIndex,instructions){var viewData=getViewData();if(ngDevMode&&assertEqual(viewData[BINDING_INDEX],-1,"i18nApply should be called before any binding"),instructions){var renderer=getRenderer(),localParentNode=getParentLNode(load(startIndex))||getPreviousOrParentNode(),localPreviousNode=localParentNode;resetApplicationState();for(var i=0;i<instructions.length;i++){var instruction=instructions[i];switch(-536870912&instruction){case 1073741824:var element$$1=load(536870911&instruction);localPreviousNode=appendI18nNode(element$$1,localParentNode,localPreviousNode),localParentNode=element$$1;break;case 1610612736:case-2147483648:case-1610612736:localPreviousNode=appendI18nNode(load(536870911&instruction),localParentNode,localPreviousNode);break;case 536870912:ngDevMode&&ngDevMode.rendererCreateTextNode++;var textRNode=createTextNode(instructions[++i],renderer);localPreviousNode=appendI18nNode(createLNode(viewData.length-HEADER_OFFSET,3,textRNode,null,null),localParentNode,localPreviousNode),resetApplicationState();break;case-1073741824:localPreviousNode=localParentNode,localParentNode=getParentLNode(localParentNode);break;case-536870912:ngDevMode&&ngDevMode.rendererRemoveNode++;var removedNode=load(536870911&instruction),parentNode=getParentLNode(removedNode);removeChild(parentNode,removedNode.native||null,viewData),0===removedNode.tNode.type&&removedNode.dynamicLContainerNode&&(removeChild(parentNode,removedNode.dynamicLContainerNode.native||null,viewData),removedNode.dynamicLContainerNode.tNode.detached=!0,removedNode.dynamicLContainerNode.data[RENDER_PARENT]=null)}}}},exports.ɵiEM=function(translation,placeholders){for(var staticText=translation.split(i18nTagRegex),i=1;i<staticText.length;i+=2)staticText[i]=placeholders[staticText[i]];return staticText},exports.ɵiI1=function(instructions,v0){if(!bindingUpdated(v0))return NO_CHANGE;for(var res="",i=0;i<instructions.length;i++)res+=1&i?stringify$1(v0):instructions[i];return res},exports.ɵiI2=function(instructions,v0,v1){if(!bindingUpdated2(v0,v1))return NO_CHANGE;for(var res="",i=0;i<instructions.length;i++)res+=1&i?stringify$1(1&instructions[i]?v1:v0):instructions[i];return res},exports.ɵiI3=function(instructions,v0,v1,v2){var different=bindingUpdated2(v0,v1);if(!(different=bindingUpdated(v2)||different))return NO_CHANGE;for(var res="",i=0;i<instructions.length;i++)if(1&i){var idx=instructions[i];res+=stringify$1(2&idx?v2:1&idx?v1:v0)}else res+=instructions[i];return res},exports.ɵiI4=function(instructions,v0,v1,v2,v3){if(!bindingUpdated4(v0,v1,v2,v3))return NO_CHANGE;for(var res="",i=0;i<instructions.length;i++)if(1&i){var idx=instructions[i],b1=1&idx;res+=stringify$1(2&idx?b1?v3:v2:b1?v1:v0)}else res+=instructions[i];return res},exports.ɵiI5=function(instructions,v0,v1,v2,v3,v4){var different=bindingUpdated4(v0,v1,v2,v3);if(!(different=bindingUpdated(v4)||different))return NO_CHANGE;for(var res="",i=0;i<instructions.length;i++)if(1&i){var idx=instructions[i],b1=1&idx;res+=stringify$1(4&idx?v4:2&idx?b1?v3:v2:b1?v1:v0)}else res+=instructions[i];return res},exports.ɵiI6=function(instructions,v0,v1,v2,v3,v4,v5){var different=bindingUpdated4(v0,v1,v2,v3);if(!(different=bindingUpdated2(v4,v5)||different))return NO_CHANGE;for(var res="",i=0;i<instructions.length;i++)if(1&i){var idx=instructions[i],b1=1&idx;res+=stringify$1(4&idx?b1?v5:v4:2&idx?b1?v3:v2:b1?v1:v0)}else res+=instructions[i];return res},exports.ɵiI7=function(instructions,v0,v1,v2,v3,v4,v5,v6){var different=bindingUpdated4(v0,v1,v2,v3);if(different=bindingUpdated2(v4,v5)||different,!(different=bindingUpdated(v6)||different))return NO_CHANGE;for(var res="",i=0;i<instructions.length;i++)if(1&i){var idx=instructions[i],b2=2&idx,b1=1&idx;res+=stringify$1(4&idx?b2?v6:b1?v5:v4:b2?b1?v3:v2:b1?v1:v0)}else res+=instructions[i];return res},exports.ɵiI8=function(instructions,v0,v1,v2,v3,v4,v5,v6,v7){var different=bindingUpdated4(v0,v1,v2,v3);if(!(different=bindingUpdated4(v4,v5,v6,v7)||different))return NO_CHANGE;for(var res="",i=0;i<instructions.length;i++)if(1&i){var idx=instructions[i],b2=2&idx,b1=1&idx;res+=stringify$1(4&idx?b2?b1?v7:v6:b1?v5:v4:b2?b1?v3:v2:b1?v1:v0)}else res+=instructions[i];return res},exports.ɵIV=function(instructions,values){for(var different=!1,i=0;i<values.length;i++)bindingUpdated(values[i])&&(different=!0);if(!different)return NO_CHANGE;var res="";for(i=0;i<instructions.length;i++)res+=1&i?stringify$1(values[instructions[i]]):instructions[i];return res},exports.ɵiM=function(translation,elements,expressions,templateRoots,lastChildIndex){var translationParts=translation.split(i18nTagRegex),nbTemplates=templateRoots?templateRoots.length+1:1,instructions=new Array(nbTemplates).fill(void 0);return function generateMappingInstructions(tmplIndex,partIndex,translationParts,instructions,elements,expressions,templateRoots,lastChildIndex){var tmplInstructions=[],phVisited=[],openedTagCount=0,maxIndex=0,currentElements=elements&&elements[tmplIndex]?elements[tmplIndex]:null,currentExpressions=expressions&&expressions[tmplIndex]?expressions[tmplIndex]:null;for(instructions[tmplIndex]=tmplInstructions;partIndex<translationParts.length;partIndex++){var value=translationParts[partIndex];if(1&partIndex){var phIndex=void 0;if(currentElements&&void 0!==currentElements[value]){phIndex=currentElements[value];var templateRootIndex=templateRoots?templateRoots.indexOf(value):-1;-1!==templateRootIndex&&templateRootIndex+1!==tmplIndex?tmplInstructions.push(-2147483648|phIndex):(tmplInstructions.push(1073741824|phIndex),openedTagCount++),phVisited.push(value)}else if(currentExpressions&&void 0!==currentExpressions[value])phIndex=currentExpressions[value],tmplInstructions.push(1610612736|phIndex),phVisited.push(value);else if(tmplInstructions.push(-1073741824),tmplIndex>0&&0==--openedTagCount)break;if(void 0!==phIndex&&phIndex>maxIndex&&(maxIndex=phIndex),templateRoots){var newTmplIndex=templateRoots.indexOf(value)+1;0!==newTmplIndex&&newTmplIndex!==tmplIndex&&(partIndex=generateMappingInstructions(newTmplIndex,partIndex,translationParts,instructions,elements,expressions,templateRoots,lastChildIndex))}}else value&&tmplInstructions.push(536870912,value)}if(elements){var tmplElements=elements[tmplIndex];if(tmplElements)for(var phKeys=Object.keys(tmplElements),i=0;i<phKeys.length;i++){var ph=phKeys[i];if(-1===phVisited.indexOf(ph)){var index=tmplElements[ph];tmplInstructions.push(-536870912|index),index>maxIndex&&(maxIndex=index)}}}if(expressions){var tmplExpressions=expressions[tmplIndex];if(tmplExpressions)for(var phKeys=Object.keys(tmplExpressions),i=0;i<phKeys.length;i++){var ph=phKeys[i];if(-1===phVisited.indexOf(ph)){var index=tmplExpressions[ph];ngDevMode&&assertLessThan(index.toString(2).length,28,"Index "+index+" is too big and will overflow"),tmplInstructions.push(-536870912|index),index>maxIndex&&(maxIndex=index)}}}if(0===tmplIndex&&"number"==typeof lastChildIndex)for(var i=maxIndex+1;i<=lastChildIndex;i++)ngDevMode&&assertLessThan(i.toString(2).length,28,"Index "+i+" is too big and will overflow"),tmplInstructions.push(-1610612736|i);return partIndex}(0,0,translationParts,instructions,elements,expressions,templateRoots,lastChildIndex),instructions},exports.ɵsanitizeHtml=function(unsafeHtml){var s=getCurrentSanitizer();return s?s.sanitize(SecurityContext.HTML,unsafeHtml)||"":allowSanitizationBypass(unsafeHtml,"Html")?unsafeHtml.toString():_sanitizeHtml(document,stringify$1(unsafeHtml))},exports.ɵsanitizeStyle=function(unsafeStyle){var s=getCurrentSanitizer();return s?s.sanitize(SecurityContext.STYLE,unsafeStyle)||"":allowSanitizationBypass(unsafeStyle,"Style")?unsafeStyle.toString():_sanitizeStyle(stringify$1(unsafeStyle))},exports.ɵsanitizeUrl=function(unsafeUrl){var s=getCurrentSanitizer();return s?s.sanitize(SecurityContext.URL,unsafeUrl)||"":allowSanitizationBypass(unsafeUrl,"Url")?unsafeUrl.toString():_sanitizeUrl(stringify$1(unsafeUrl))},exports.ɵsanitizeResourceUrl=function(unsafeResourceUrl){var s=getCurrentSanitizer();if(s)return s.sanitize(SecurityContext.RESOURCE_URL,unsafeResourceUrl)||"";if(allowSanitizationBypass(unsafeResourceUrl,"ResourceUrl"))return unsafeResourceUrl.toString();throw new Error("unsafe value used in a resource URL context (see http://g.co/ng/security#xss)")},exports.ɵbypassSanitizationTrustHtml=function(trustedHtml){return bypassSanitizationTrustString(trustedHtml,"Html")},exports.ɵbypassSanitizationTrustStyle=function(trustedStyle){return bypassSanitizationTrustString(trustedStyle,"Style")},exports.ɵbypassSanitizationTrustScript=function(trustedScript){return bypassSanitizationTrustString(trustedScript,"Script")},exports.ɵbypassSanitizationTrustUrl=function(trustedUrl){return bypassSanitizationTrustString(trustedUrl,"Url")},exports.ɵbypassSanitizationTrustResourceUrl=function(trustedResourceUrl){return bypassSanitizationTrustString(trustedResourceUrl,"ResourceUrl")},exports.ɵregisterModuleFactory=function(id,factory){var existing=moduleFactories.get(id);if(existing)throw new Error("Duplicate module registered for "+id+" - "+existing.moduleType.name+" vs "+factory.moduleType.name);moduleFactories.set(id,factory)},exports.ɵEMPTY_ARRAY=[],exports.ɵEMPTY_MAP={},exports.ɵand=
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
