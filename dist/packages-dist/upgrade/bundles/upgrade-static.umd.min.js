 ...
 */function noNg(){throw new Error("AngularJS v1.x is not loaded!")}var noNgElement=function(){return noNg()};noNgElement.cleanData=noNg;var angular={bootstrap:noNg,module:noNg,element:noNgElement,version:void 0,resumeBootstrap:noNg,getTestability:noNg};try{window.hasOwnProperty("angular")&&(angular=window.angular)}catch(e){}function setAngularJSGlobal(ng){angular=ng,ng&&ng.version}function getAngularJSGlobal(){return angular}var module$1=function(prefix,dependencies){return angular.module(prefix,dependencies)},element=function(e){return angular.element(e)};element.cleanData=function(nodes){return angular.element.cleanData(nodes)};angular.version;
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var $COMPILE="$compile",$CONTROLLER="$controller",$INJECTOR="$injector",$PARSE="$parse",$SCOPE="$scope",INJECTOR_KEY="$$angularInjector",LAZY_MODULE_REF="$$angularLazyModuleRef",REQUIRE_INJECTOR="?^^"+INJECTOR_KEY,REQUIRE_NG_MODEL="?ngModel",UPGRADE_MODULE_NAME="$$UpgradeModule",PropertyBinding=function(){function PropertyBinding(prop,attr){this.prop=prop,this.attr=attr,this.parseBinding()}return PropertyBinding.prototype.parseBinding=function(){this.bracketAttr="["+this.attr+"]",this.parenAttr="("+this.attr+")",this.bracketParenAttr="[("+this.attr+")]";var capitalAttr=this.attr.charAt(0).toUpperCase()+this.attr.substr(1);this.onAttr="on"+capitalAttr,this.bindAttr="bind"+capitalAttr,this.bindonAttr="bindon"+capitalAttr},PropertyBinding}(),DIRECTIVE_PREFIX_REGEXP=/^(?:x|data)[:\-_]/i,DIRECTIVE_SPECIAL_CHARS_REGEXP=/[:\-_]+(.)/g;function controllerKey(name){return"$"+name+"Controller"}function getComponentName(component){return component.overriddenName||component.name||component.toString().split("\n")[0]}function isFunction(value){return"function"==typeof value}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var ParentInjectorPromise=function(){function ParentInjectorPromise(element){this.element=element,this.injectorKey=controllerKey(INJECTOR_KEY),this.callbacks=[],element.data(this.injectorKey,this)}return ParentInjectorPromise.prototype.then=function(callback){this.injector?callback(this.injector):this.callbacks.push(callback)},ParentInjectorPromise.prototype.resolve=function(injector){this.injector=injector,this.element.data(this.injectorKey,injector),this.element=null,this.callbacks.forEach(function(callback){return callback(injector)}),this.callbacks.length=0},ParentInjectorPromise}();
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
var tempInjectorRef,VERSION=new _angular_core.Version("6.1.10-bea78b0");
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function setTempInjectorRef(injector){tempInjectorRef=injector}function injectorFactory(){if(!tempInjectorRef)throw new Error("Trying to get the AngularJS injector before it being set.");var injector=tempInjectorRef;return tempInjectorRef=null,injector}function rootScopeFactory(i){return i.get("$rootScope")}function compileFactory(i){return i.get("$compile")}function parseFactory(i){return i.get("$parse")}var angular1Providers=[{provide:"$injector",useFactory:injectorFactory,deps:[]},{provide:"$rootScope",useFactory:rootScopeFactory,deps:["$injector"]},{provide:"$compile",useFactory:compileFactory,deps:["$injector"]},{provide:"$parse",useFactory:parseFactory,deps:["$injector"]}],NgAdapterInjector=function(){function NgAdapterInjector(modInjector){this.modInjector=modInjector}return NgAdapterInjector.prototype.get=function(token,notFoundValue){return notFoundValue===_angular_core.ɵNOT_FOUND_CHECK_ONLY_ELEMENT_INJECTOR?notFoundValue:this.modInjector.get(token,notFoundValue)},NgAdapterInjector}();
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function(token){var factory=function(i){return i.get(token)};return factory.$inject=[INJECTOR_KEY],factory},exports.VERSION=VERSION,exports.downgradeModule=
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
