 ...
 * License: MIT
 */
!function(global,factory){"object"==typeof exports&&"undefined"!=typeof module?factory(exports,require("@angular/core"),require("@angular/platform-browser-dynamic")):"function"==typeof define&&define.amd?define("@angular/upgrade",["exports","@angular/core","@angular/platform-browser-dynamic"],factory):factory((global.ng=global.ng||{},global.ng.upgrade={}),global.ng.core,global.ng.platformBrowserDynamic)}(this,function(exports,_angular_core,_angular_platformBrowserDynamic){"use strict";var __assign=function(){return(__assign=Object.assign||function(t){for(var s,i=1,n=arguments.length;i<n;i++)for(var p in s=arguments[i])Object.prototype.hasOwnProperty.call(s,p)&&(t[p]=s[p]);return t}).apply(this,arguments)},VERSION=new _angular_core.Version("6.1.10-bea78b0");
/**
 * @license Angular v6.1.10-bea78b0
 * (c) 2010-2018 Google, Inc. https://angular.io/
 * License: MIT
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function noNg(){throw new Error("AngularJS v1.x is not loaded!")}var noNgElement=function(){return noNg()};noNgElement.cleanData=noNg;var angular={bootstrap:noNg,module:noNg,element:noNgElement,version:void 0,resumeBootstrap:noNg,getTestability:noNg};try{window.hasOwnProperty("angular")&&(angular=window.angular)}catch(e){}var element=function(e){return angular.element(e)};element.cleanData=function(nodes){return angular.element.cleanData(nodes)};
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
var $COMPILE="$compile",$CONTROLLER="$controller",$INJECTOR="$injector",$PARSE="$parse",$SCOPE="$scope",INJECTOR_KEY="$$angularInjector",LAZY_MODULE_REF="$$angularLazyModuleRef",REQUIRE_INJECTOR="?^^"+INJECTOR_KEY,REQUIRE_NG_MODEL="?ngModel",PropertyBinding=function(){function PropertyBinding(prop,attr){this.prop=prop,this.attr=attr,this.parseBinding()}return PropertyBinding.prototype.parseBinding=function(){this.bracketAttr="["+this.attr+"]",this.parenAttr="("+this.attr+")",this.bracketParenAttr="[("+this.attr+")]";var capitalAttr=this.attr.charAt(0).toUpperCase()+this.attr.substr(1);this.onAttr="on"+capitalAttr,this.bindAttr="bind"+capitalAttr,this.bindonAttr="bindon"+capitalAttr},PropertyBinding}(),DIRECTIVE_PREFIX_REGEXP=/^(?:x|data)[:\-_]/i,DIRECTIVE_SPECIAL_CHARS_REGEXP=/[:\-_]+(.)/g;function onError(e){throw console.error?console.error(e,e.stack):console.log(e,e.stack),e}function controllerKey(name){return"$"+name+"Controller"}function getComponentName(component){return component.overriddenName||component.name||component.toString().split("\n")[0]}function isFunction(value){return"function"==typeof value}var Deferred=function(){return function(){var _this=this;this.promise=new Promise(function(res,rej){_this.resolve=res,_this.reject=rej})}}();function strictEquals(val1,val2){return val1===val2||val1!=val1&&val2!=val2}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
