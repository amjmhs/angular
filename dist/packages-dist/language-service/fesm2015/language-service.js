...
function create(info /* ts.server.PluginCreateInfo */) {
    ...
    function tryFilenameFiveCall(m) {
        return (fileName, p1, p2, p3, p4, p5) => tryCall(fileName, () => (m.call(ls, fileName, p1, p2, p3, p4, p5)));
    }
    function typescriptOnly(ls) {
        const languageService = {
            ...
            getCombinedCodeFix: (scope, fixId, formatOptions, preferences) => tryCall(undefined, () => ls.getCombinedCodeFix(scope, fixId, formatOptions, preferences)),
            // TODO(kyliau): dummy implementation to compile with ts 2.8, create real one
            getSuggestionDiagnostics: (fileName) => [],
            // TODO(kyliau): dummy implementation to compile with ts 2.8, create real one
            organizeImports: (scope, formatOptions) => [],
