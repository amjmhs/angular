 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */var $EOF=0,$TAB=9,$LF=10,$VTAB=11,$FF=12,$CR=13,$SPACE=32,$DQ=34,$$=36,$SQ=39,$PLUS=43,$MINUS=45,$SLASH=47,$SEMICOLON=59,$EQ=61,$GT=62,$0=48,$9=57,$A=65,$E=69,$F=70,$Z=90,$_=95,$a=97,$e=101,$f=102,$n=110,$r=114,$t=116,$v=118,$z=122,$LBRACE=123,$NBSP=160,$BT=96;function isWhitespace(code){return code>=$TAB&&code<=$SPACE||code==$NBSP}function isDigit(code){return $0<=code&&code<=$9}function isAsciiLetter(code){return code>=$a&&code<=$z||code>=$A&&code<=$Z}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
var CORE$1="@angular/core",Identifiers$1=function(){function Identifiers(){}return Identifiers.NEW_METHOD="factory",Identifiers.TRANSFORM_METHOD="transform",Identifiers.PATCH_DEPS="patchedDeps",Identifiers.namespaceHTML={name:"ɵNH",moduleName:CORE$1},Identifiers.namespaceMathML={name:"ɵNM",moduleName:CORE$1},Identifiers.namespaceSVG={name:"ɵNS",moduleName:CORE$1},Identifiers.element={name:"ɵEe",moduleName:CORE$1},Identifiers.elementStart={name:"ɵE",moduleName:CORE$1},Identifiers.elementEnd={name:"ɵe",moduleName:CORE$1},Identifiers.elementProperty={name:"ɵp",moduleName:CORE$1},Identifiers.elementAttribute={name:"ɵa",moduleName:CORE$1},Identifiers.elementClassProp={name:"ɵcp",moduleName:CORE$1},Identifiers.elementStyling={name:"ɵs",moduleName:CORE$1},Identifiers.elementStylingMap={name:"ɵsm",moduleName:CORE$1},Identifiers.elementStyleProp={name:"ɵsp",moduleName:CORE$1},Identifiers.elementStylingApply={name:"ɵsa",moduleName:CORE$1},Identifiers.containerCreate={name:"ɵC",moduleName:CORE$1},Identifiers.text={name:"ɵT",moduleName:CORE$1},Identifiers.textBinding={name:"ɵt",moduleName:CORE$1},Identifiers.bind={name:"ɵb",moduleName:CORE$1},Identifiers.interpolation1={name:"ɵi1",moduleName:CORE$1},Identifiers.interpolation2={name:"ɵi2",moduleName:CORE$1},Identifiers.interpolation3={name:"ɵi3",moduleName:CORE$1},Identifiers.interpolation4={name:"ɵi4",moduleName:CORE$1},Identifiers.interpolation5={name:"ɵi5",moduleName:CORE$1},Identifiers.interpolation6={name:"ɵi6",moduleName:CORE$1},Identifiers.interpolation7={name:"ɵi7",moduleName:CORE$1},Identifiers.interpolation8={name:"ɵi8",moduleName:CORE$1},Identifiers.interpolationV={name:"ɵiV",moduleName:CORE$1},Identifiers.pureFunction0={name:"ɵf0",moduleName:CORE$1},Identifiers.pureFunction1={name:"ɵf1",moduleName:CORE$1},Identifiers.pureFunction2={name:"ɵf2",moduleName:CORE$1},Identifiers.pureFunction3={name:"ɵf3",moduleName:CORE$1},Identifiers.pureFunction4={name:"ɵf4",moduleName:CORE$1},Identifiers.pureFunction5={name:"ɵf5",moduleName:CORE$1},Identifiers.pureFunction6={name:"ɵf6",moduleName:CORE$1},Identifiers.pureFunction7={name:"ɵf7",moduleName:CORE$1},Identifiers.pureFunction8={name:"ɵf8",moduleName:CORE$1},Identifiers.pureFunctionV={name:"ɵfV",moduleName:CORE$1},Identifiers.pipeBind1={name:"ɵpb1",moduleName:CORE$1},Identifiers.pipeBind2={name:"ɵpb2",moduleName:CORE$1},Identifiers.pipeBind3={name:"ɵpb3",moduleName:CORE$1},Identifiers.pipeBind4={name:"ɵpb4",moduleName:CORE$1},Identifiers.pipeBindV={name:"ɵpbV",moduleName:CORE$1},Identifiers.load={name:"ɵld",moduleName:CORE$1},Identifiers.loadDirective={name:"ɵd",moduleName:CORE$1},Identifiers.loadQueryList={name:"ɵql",moduleName:CORE$1},Identifiers.pipe={name:"ɵPp",moduleName:CORE$1},Identifiers.projection={name:"ɵP",moduleName:CORE$1},Identifiers.projectionDef={name:"ɵpD",moduleName:CORE$1},Identifiers.inject={name:"inject",moduleName:CORE$1},Identifiers.injectAttribute={name:"ɵinjectAttribute",moduleName:CORE$1},Identifiers.injectElementRef={name:"ɵinjectElementRef",moduleName:CORE$1},Identifiers.injectTemplateRef={name:"ɵinjectTemplateRef",moduleName:CORE$1},Identifiers.injectViewContainerRef={name:"ɵinjectViewContainerRef",moduleName:CORE$1},Identifiers.injectChangeDetectorRef={name:"ɵinjectChangeDetectorRef",moduleName:CORE$1},Identifiers.directiveInject={name:"ɵdirectiveInject",moduleName:CORE$1},Identifiers.defineComponent={name:"ɵdefineComponent",moduleName:CORE$1},Identifiers.ComponentDef={name:"ɵComponentDef",moduleName:CORE$1},Identifiers.defineDirective={name:"ɵdefineDirective",moduleName:CORE$1},Identifiers.DirectiveDef={name:"ɵDirectiveDef",moduleName:CORE$1},Identifiers.InjectorDef={name:"ɵInjectorDef",moduleName:CORE$1},Identifiers.defineInjector={name:"defineInjector",moduleName:CORE$1},Identifiers.NgModuleDef={name:"ɵNgModuleDef",moduleName:CORE$1},Identifiers.defineNgModule={name:"ɵdefineNgModule",moduleName:CORE$1},Identifiers.PipeDef={name:"ɵPipeDef",moduleName:CORE$1},Identifiers.definePipe={name:"ɵdefinePipe",moduleName:CORE$1},Identifiers.query={name:"ɵQ",moduleName:CORE$1},Identifiers.queryRefresh={name:"ɵqR",moduleName:CORE$1},Identifiers.registerContentQuery={name:"ɵQr",moduleName:CORE$1},Identifiers.NgOnChangesFeature={name:"ɵNgOnChangesFeature",moduleName:CORE$1},Identifiers.InheritDefinitionFeature={name:"ɵInheritDefinitionFeature",moduleName:CORE$1},Identifiers.listener={name:"ɵL",moduleName:CORE$1},Identifiers.reserveSlots={name:"ɵrS",moduleName:CORE$1},Identifiers.sanitizeHtml={name:"ɵzh",moduleName:CORE$1},Identifiers.sanitizeStyle={name:"ɵzs",moduleName:CORE$1},Identifiers.defaultStyleSanitizer={name:"ɵzss",moduleName:CORE$1},Identifiers.sanitizeResourceUrl={name:"ɵzr",moduleName:CORE$1},Identifiers.sanitizeScript={name:"ɵzc",moduleName:CORE$1},Identifiers.sanitizeUrl={name:"ɵzu",moduleName:CORE$1},Identifiers}(),TEMPORARY_NAME="_t",CONTEXT_NAME="ctx",RENDER_FLAGS="rf",MEANING_SEPARATOR$1="|",ID_SEPARATOR$1="@@";function temporaryAllocator(statements,name){var temp=null;return function(){return temp||(statements.push(new DeclareVarStmt(TEMPORARY_NAME,void 0,DYNAMIC_TYPE)),temp=variable(name)),temp}}function unsupported(feature){if(this)throw new Error("Builder "+this.constructor.name+" doesn't support "+feature+" yet");throw new Error("Feature "+feature+" is not supported yet")}function invalid$1(arg){throw new Error("Invalid state: Visitor "+this.constructor.name+" doesn't handle "+void 0)}function asLiteral(value){return Array.isArray(value)?literalArr(value.map(asLiteral)):literal(value,INFERRED_TYPE)}function conditionallyCreateMapObjectLiteral(keys){return Object.getOwnPropertyNames(keys).length>0?mapToExpression(keys):null}function mapToExpression(map,quoted){return void 0===quoted&&(quoted=!1),literalMap(Object.getOwnPropertyNames(map).map(function(key){return{key:key,quoted:quoted,value:asLiteral(map[key])}}))}function trimTrailingNulls(parameters){for(;(exp=parameters[parameters.length-1])instanceof LiteralExpr&&null===exp.value;)parameters.pop();var exp;return parameters}function noop(){}var DefinitionMap=function(){function DefinitionMap(){this.values=[]}return DefinitionMap.prototype.set=function(key,value){value&&this.values.push({key:key,value:value,quoted:!1})},DefinitionMap.prototype.toLiteralMap=function(){return literalMap(this.values)},DefinitionMap}(),R3ResolvedDependencyType={Token:0,Attribute:1,Injector:2,ElementRef:3,TemplateRef:4,ViewContainerRef:5,ChangeDetectorRef:6};
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function compileFactoryFunction(meta){var args=meta.deps.map(function(dep){return function(dep,injectFn){switch(dep.resolved){case R3ResolvedDependencyType.Token:case R3ResolvedDependencyType.Injector:var flags=0|(dep.self?2:0)|(dep.skipSelf?4:0)|(dep.host?1:0)|(dep.optional?8:0),token=dep.token;dep.resolved===R3ResolvedDependencyType.Injector&&(token=importExpr(Identifiers.INJECTOR));var injectArgs=[token];return(0!==flags||dep.optional)&&injectArgs.push(literal(flags)),importExpr(injectFn).callFn(injectArgs);case R3ResolvedDependencyType.Attribute:return importExpr(Identifiers$1.injectAttribute).callFn([dep.token]);case R3ResolvedDependencyType.ElementRef:return importExpr(Identifiers$1.injectElementRef).callFn([]);case R3ResolvedDependencyType.TemplateRef:return importExpr(Identifiers$1.injectTemplateRef).callFn([]);case R3ResolvedDependencyType.ViewContainerRef:return importExpr(Identifiers$1.injectViewContainerRef).callFn([]);case R3ResolvedDependencyType.ChangeDetectorRef:return importExpr(Identifiers$1.injectChangeDetectorRef).callFn([]);default:return unsupported("Unknown R3ResolvedDependencyType: "+R3ResolvedDependencyType[dep.resolved])}}(dep,meta.injectFn)}),expr=meta.useNew?new InstantiateExpr(meta.fnOrClass,args):new InvokeFunctionExpr(meta.fnOrClass,args);return fn([],[new ReturnStatement(expr)],INFERRED_TYPE,void 0,meta.name+"_Factory")}function dependenciesFromGlobalMetadata(type,outputCtx,reflector){for(var elementRef=reflector.resolveExternalReference(Identifiers.ElementRef),templateRef=reflector.resolveExternalReference(Identifiers.TemplateRef),viewContainerRef=reflector.resolveExternalReference(Identifiers.ViewContainerRef),injectorRef=reflector.resolveExternalReference(Identifiers.Injector),deps=[],_i=0,_a=type.diDeps;_i<_a.length;_i++){var dependency=_a[_i];if(dependency.token){var tokenRef=tokenReference(dependency.token),resolved=R3ResolvedDependencyType.Token;tokenRef===elementRef?resolved=R3ResolvedDependencyType.ElementRef:tokenRef===templateRef?resolved=R3ResolvedDependencyType.TemplateRef:tokenRef===viewContainerRef?resolved=R3ResolvedDependencyType.ViewContainerRef:tokenRef===injectorRef?resolved=R3ResolvedDependencyType.Injector:dependency.isAttribute&&(resolved=R3ResolvedDependencyType.Attribute);var token=tokenRef instanceof StaticSymbol?outputCtx.importExpr(tokenRef):literal(tokenRef);deps.push({token:token,resolved:resolved,host:!!dependency.isHost,optional:!!dependency.isOptional,self:!!dependency.isSelf,skipSelf:!!dependency.isSkipSelf})}else unsupported("dependency without a token")}return deps}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function mapToMapExpression(map){return literalMap(Object.keys(map).map(function(key){return{key:key,value:map[key],quoted:!1}}))}function convertMetaToOutput(meta,ctx){if(Array.isArray(meta))return literalArr(meta.map(function(entry){return convertMetaToOutput(entry,ctx)}));if(meta instanceof StaticSymbol)return ctx.importExpr(meta);if(null==meta)return literal(meta);throw new Error("Internal error: Unsupported or unknown metadata: "+meta)}function typeWithParameters(type,numParams){var params=null;if(numParams>0){params=[];for(var i=0;i<numParams;i++)params.push(DYNAMIC_TYPE)}return expressionType(type,null,params)}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function compilePipeFromMetadata(metadata){var definitionMapValues=[];definitionMapValues.push({key:"name",value:literal(metadata.pipeName),quoted:!1}),definitionMapValues.push({key:"type",value:metadata.type,quoted:!1});var templateFactory=compileFactoryFunction({name:metadata.name,fnOrClass:metadata.type,deps:metadata.deps,useNew:!0,injectFn:Identifiers$1.directiveInject});return definitionMapValues.push({key:"factory",value:templateFactory,quoted:!1}),definitionMapValues.push({key:"pure",value:literal(metadata.pure),quoted:!1}),{expression:importExpr(Identifiers$1.definePipe).callFn([literalMap(definitionMapValues)]),type:new ExpressionType(importExpr(Identifiers$1.PipeDef,[new ExpressionType(metadata.type),new ExpressionType(new LiteralExpr(metadata.pipeName))]))}}R3ResolvedDependencyType[R3ResolvedDependencyType.Token]="Token",R3ResolvedDependencyType[R3ResolvedDependencyType.Attribute]="Attribute",R3ResolvedDependencyType[R3ResolvedDependencyType.Injector]="Injector",R3ResolvedDependencyType[R3ResolvedDependencyType.ElementRef]="ElementRef",R3ResolvedDependencyType[R3ResolvedDependencyType.TemplateRef]="TemplateRef",R3ResolvedDependencyType[R3ResolvedDependencyType.ViewContainerRef]="ViewContainerRef",R3ResolvedDependencyType[R3ResolvedDependencyType.ChangeDetectorRef]="ChangeDetectorRef";
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */function renderFlagCheckIfStmt(flags,statements){return condition=variable(RENDER_FLAGS).bitwiseAnd(literal(flags),null,!1),new IfStmt(condition,statements,elseClause);var condition,elseClause}var TemplateDefinitionBuilder=function(){function TemplateDefinitionBuilder(constantPool,contextParameter,parentBindingScope,level,contextName,templateName,viewQueries,directiveMatcher,directives,pipeTypeByName,pipes,_namespace){void 0===level&&(level=0);var _this=this;this.constantPool=constantPool,this.contextParameter=contextParameter,this.level=level,this.contextName=contextName,this.templateName=templateName,this.viewQueries=viewQueries,this.directiveMatcher=directiveMatcher,this.directives=directives,this.pipeTypeByName=pipeTypeByName,this.pipes=pipes,this._namespace=_namespace,this._dataIndex=0,this._bindingContext=0,this._prefixCode=[],this._creationCode=[],this._variableCode=[],this._bindingCode=[],this._postfixCode=[],this._unsupported=unsupported,this._inI18nSection=!1,this._i18nSectionIndex=-1,this._phToNodeIdxes=[{}],this._pureFunctionSlots=0,this.visitReference=invalid$1,this.visitVariable=invalid$1,this.visitTextAttribute=invalid$1,this.visitBoundAttribute=invalid$1,this.visitBoundEvent=invalid$1,this._dataIndex=viewQueries.length,this._bindingScope=parentBindingScope.nestedScope(function(lhsVar,expression){_this._bindingCode.push(lhsVar.set(expression).toDeclStmt(INFERRED_TYPE,[StmtModifier.Final]))}),this._valueConverter=new ValueConverter(constantPool,function(){return _this.allocateDataSlot()},function(numSlots){return _this._pureFunctionSlots+=numSlots},function(name,localName,slot,value){var pipeType=pipeTypeByName.get(name);pipeType&&_this.pipes.add(pipeType),_this._bindingScope.set(localName,value),_this._creationCode.push(importExpr(Identifiers$1.pipe).callFn([literal(slot),literal(name)]).toStmt())})}return TemplateDefinitionBuilder.prototype.buildTemplateFunction=function(nodes,variables,hasNgContent,ngContentSelectors){void 0===hasNgContent&&(hasNgContent=!1),void 0===ngContentSelectors&&(ngContentSelectors=[]),this._namespace!==Identifiers$1.namespaceHTML&&this.instruction(this._creationCode,null,this._namespace);for(var _i=0,variables_1=variables;_i<variables_1.length;_i++){var variable$$1=variables_1[_i],variableName=variable$$1.name,expression=variable(this.contextParameter).prop(variable$$1.value||"$implicit"),scopedName=this._bindingScope.freshReferenceName();this._bindingScope.set(variableName,variable(variableName+scopedName),expression)}if(hasNgContent){var parameters=[];if(ngContentSelectors.length>1){var r3Selectors=ngContentSelectors.map(function(s){return parseSelectorToR3Selector(s)}),parsed=this.constantPool.getConstLiteral(asLiteral(r3Selectors),!0),unParsed=this.constantPool.getConstLiteral(asLiteral(ngContentSelectors),!0);parameters.push(parsed,unParsed)}this.instruction.apply(this,[this._creationCode,null,Identifiers$1.projectionDef].concat(parameters))}visitAll$1(this,nodes),this._pureFunctionSlots>0&&this.instruction(this._creationCode,null,Identifiers$1.reserveSlots,literal(this._pureFunctionSlots));for(var creationCode=this._creationCode.length>0?[renderFlagCheckIfStmt(1,this._creationCode)]:[],updateCode=this._bindingCode.length>0?[renderFlagCheckIfStmt(2,this._bindingCode)]:[],_a=0,_b=this._phToNodeIdxes;_a<_b.length;_a++){var phToNodeIdx=_b[_a];if(Object.keys(phToNodeIdx).length>0){var phMap=variable(scopedName=this._bindingScope.freshReferenceName()).set(mapToExpression(phToNodeIdx,!0)).toDeclStmt(INFERRED_TYPE,[StmtModifier.Final]);this._prefixCode.push(phMap)}}return fn([new FnParam(RENDER_FLAGS,NUMBER_TYPE),new FnParam(this.contextParameter,null)],this._prefixCode.concat(creationCode,this._variableCode,updateCode,this._postfixCode),INFERRED_TYPE,null,this.templateName)},TemplateDefinitionBuilder.prototype.getLocal=function(name){return this._bindingScope.get(name)},TemplateDefinitionBuilder.prototype.visitContent=function(ngContent){var slot=this.allocateDataSlot(),selectorIndex=ngContent.selectorIndex,parameters=[literal(slot)],attributeAsList=[];ngContent.attributes.forEach(function(attribute){var name=attribute.name;"select"!==name&&attributeAsList.push(name,attribute.value)}),attributeAsList.length>0?parameters.push(literal(selectorIndex),asLiteral(attributeAsList)):0!==selectorIndex&&parameters.push(literal(selectorIndex)),this.instruction.apply(this,[this._creationCode,ngContent.sourceSpan,Identifiers$1.projection].concat(parameters))},TemplateDefinitionBuilder.prototype.getNamespaceInstruction=function(namespaceKey){switch(namespaceKey){case"math":return Identifiers$1.namespaceMathML;case"svg":return Identifiers$1.namespaceSVG;default:return Identifiers$1.namespaceHTML}},TemplateDefinitionBuilder.prototype.addNamespaceInstruction=function(nsInstruction,element){this._namespace=nsInstruction,this.instruction(this._creationCode,element.sourceSpan,nsInstruction)},TemplateDefinitionBuilder.prototype.visitElement=function(element){var _a,_b,_this=this,elementIndex=this.allocateDataSlot(),referenceDataSlots=new Map,wasInI18nSection=this._inI18nSection,outputAttrs={},attrI18nMetas={},i18nMeta="",_c=splitNsName(element.name),namespaceKey=_c[0],elementName=_c[1];if(this._inI18nSection){var phName=element.name.toLowerCase();this._phToNodeIdxes[this._i18nSectionIndex][phName]||(this._phToNodeIdxes[this._i18nSectionIndex][phName]=[]),this._phToNodeIdxes[this._i18nSectionIndex][phName].push(elementIndex)}for(var _i=0,_d=element.attributes;_i<_d.length;_i++){var attr=_d[_i],name_1=attr.name,value=attr.value;if("i18n"===name_1){if(this._inI18nSection)throw new Error("Could not mark an element as translatable inside of a translatable section");this._inI18nSection=!0,this._i18nSectionIndex++,this._phToNodeIdxes[this._i18nSectionIndex]={},i18nMeta=value}else name_1.startsWith("i18n-")?attrI18nMetas[name_1.slice("i18n-".length)]=value:outputAttrs[name_1]=value}if(this.directiveMatcher){var selector=createCssSelector(element.name,outputAttrs);this.directiveMatcher.match(selector,function(sel,staticType){_this.directives.add(staticType)})}var parameters=[literal(elementIndex),literal(elementName)],i18nMessages=[],attributes=[],initialStyleDeclarations=[],initialClassDeclarations=[],styleInputs=[],classInputs=[],allOtherInputs=[];element.inputs.forEach(function(input){switch(input.type){case 0:"style"==input.name?styleInputs.splice(0,0,input):isClassBinding(input)?classInputs.splice(0,0,input):allOtherInputs.push(input);break;case 3:styleInputs.push(input);break;case 2:classInputs.push(input);break;default:allOtherInputs.push(input)}});var currStyleIndex=0,currClassIndex=0,staticStylesMap=null,staticClassesMap=null,stylesIndexMap={},classesIndexMap={};Object.getOwnPropertyNames(outputAttrs).forEach(function(name){var value=outputAttrs[name];if("style"==name)staticStylesMap=function(value){for(var styles={},i=0,parenDepth=0,quote=0,valueStart=0,propStart=0,currentProp=null,valueHasQuotes=!1;i<value.length;)switch(value.charCodeAt(i++)){case 40:parenDepth++;break;case 41:parenDepth--;break;case 39:valueHasQuotes=valueHasQuotes||valueStart>0,0===quote?quote=39:39===quote&&92!==value.charCodeAt(i-1)&&(quote=0);break;case 34:valueHasQuotes=valueHasQuotes||valueStart>0,0===quote?quote=34:34===quote&&92!==value.charCodeAt(i-1)&&(quote=0);break;case 58:currentProp||0!==parenDepth||0!==quote||(currentProp=hyphenate(value.substring(propStart,i-1).trim()),valueStart=i);break;case 59:if(currentProp&&valueStart>0&&0===parenDepth&&0===quote){var styleVal=value.substring(valueStart,i-1).trim();styles[currentProp]=valueHasQuotes?stripUnnecessaryQuotes(styleVal):styleVal,propStart=i,valueStart=0,currentProp=null,valueHasQuotes=!1}}currentProp&&valueStart&&(styleVal=value.substr(valueStart).trim(),styles[currentProp]=valueHasQuotes?stripUnnecessaryQuotes(styleVal):styleVal);return styles}(value),Object.keys(staticStylesMap).forEach(function(prop){stylesIndexMap[prop]=currStyleIndex++});else if("class"==name)staticClassesMap={},value.split(/\s+/g).forEach(function(className){classesIndexMap[className]=currClassIndex++,staticClassesMap[className]=!0});else if(attributes.push(literal(name)),attrI18nMetas.hasOwnProperty(name)){var meta=parseI18nMeta(attrI18nMetas[name]),variable$$1=_this.constantPool.getTranslation(value,meta);attributes.push(variable$$1)}else attributes.push(literal(value))});for(var hasMapBasedStyling=!1,i=0;i<styleInputs.length;i++){var input=styleInputs[i];0===i&&"style"===input.name?hasMapBasedStyling=!0:stylesIndexMap.hasOwnProperty(input.name)||(stylesIndexMap[input.name]=currStyleIndex++)}for(i=0;i<classInputs.length;i++){input=classInputs[i];0===i&&isClassBinding(input)||stylesIndexMap.hasOwnProperty(input.name)||(classesIndexMap[input.name]=currClassIndex++)}var useDefaultStyleSanitizer=hasMapBasedStyling;Object.keys(stylesIndexMap).forEach(function(prop){useDefaultStyleSanitizer=useDefaultStyleSanitizer||function(prop){switch(prop){case"background-image":case"background":case"border-image":case"filter":case"list-style":case"list-style-image":return!0}return!1}
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 * Use of this source code is governed by an MIT-style license that can be
 * found in the LICENSE file at https://angular.io/license
 */(prop),initialStyleDeclarations.push(literal(prop))}),staticStylesMap&&(initialStyleDeclarations.push(literal(1)),Object.keys(staticStylesMap).forEach(function(prop){initialStyleDeclarations.push(literal(prop));var value=staticStylesMap[prop];initialStyleDeclarations.push(literal(value))})),Object.keys(classesIndexMap).forEach(function(prop){initialClassDeclarations.push(literal(prop))}),staticClassesMap&&(initialClassDeclarations.push(literal(1)),Object.keys(staticClassesMap).forEach(function(className){initialClassDeclarations.push(literal(className)),initialClassDeclarations.push(literal(!0))}));var hasStylingInstructions=initialStyleDeclarations.length||styleInputs.length||initialClassDeclarations.length||classInputs.length,attrArg=attributes.length>0?this.constantPool.getConstLiteral(literalArr(attributes),!0):TYPED_NULL_EXPR;if(parameters.push(attrArg),element.references&&element.references.length>0){var references=flatten(element.references.map(function(reference){var slot=_this.allocateDataSlot();referenceDataSlots.set(reference.name,slot);var variableName=_this._bindingScope.freshReferenceName();return _this._variableCode.push(variable(variableName,INFERRED_TYPE).set(importExpr(Identifiers$1.load).callFn([literal(slot)])).toDeclStmt(INFERRED_TYPE,[StmtModifier.Final])),_this._bindingScope.set(reference.name,variable(variableName)),[reference.name,reference.value]}));parameters.push(this.constantPool.getConstLiteral(asLiteral(references),!0))}else parameters.push(TYPED_NULL_EXPR);i18nMessages.length>0&&(_a=this._creationCode).push.apply(_a,i18nMessages);var wasInNamespace=this._namespace,currentNamespace=this.getNamespaceInstruction(namespaceKey);currentNamespace!==wasInNamespace&&this.addNamespaceInstruction(currentNamespace,element);var implicit=variable(CONTEXT_NAME),createSelfClosingInstruction=!hasStylingInstructions&&0===element.children.length&&0===element.outputs.length;if(createSelfClosingInstruction)this.instruction.apply(this,[this._creationCode,element.sourceSpan,Identifiers$1.element].concat(trimTrailingNulls(parameters)));else{if(i18nMessages.length>0&&(_b=this._creationCode).push.apply(_b,i18nMessages),this.instruction.apply(this,[this._creationCode,element.sourceSpan,Identifiers$1.elementStart].concat(trimTrailingNulls(parameters))),hasStylingInstructions){var paramsList=[];initialClassDeclarations.length?paramsList.push(this.constantPool.getConstLiteral(literalArr(initialClassDeclarations),!0)):(initialStyleDeclarations.length||useDefaultStyleSanitizer)&&paramsList.push(NULL_EXPR),initialStyleDeclarations.length?paramsList.push(this.constantPool.getConstLiteral(literalArr(initialStyleDeclarations),!0)):useDefaultStyleSanitizer&&paramsList.push(NULL_EXPR),useDefaultStyleSanitizer&&paramsList.push(importExpr(Identifiers$1.defaultStyleSanitizer)),this._creationCode.push(importExpr(Identifiers$1.elementStyling).callFn(paramsList).toStmt())}element.outputs.forEach(function(outputAst){var elName=sanitizeIdentifier(element.name),evName=sanitizeIdentifier(outputAst.name),functionName=_this.templateName+"_"+elName+"_"+evName+"_listener",localVars=[],bindingExpr=convertActionBinding(_this._bindingScope.nestedScope(function(lhsVar,rhsExpression){localVars.push(lhsVar.set(rhsExpression).toDeclStmt(INFERRED_TYPE,[StmtModifier.Final]))}),implicit,outputAst.handler,"b",function(){return error("Unexpected interpolation")}),handler=fn([new FnParam("$event",DYNAMIC_TYPE)],localVars.concat(bindingExpr.render3Stmts),INFERRED_TYPE,null,functionName);_this.instruction(_this._creationCode,outputAst.sourceSpan,Identifiers$1.listener,literal(outputAst.name),handler)})}if((styleInputs.length||classInputs.length)&&hasStylingInstructions){var indexLiteral=literal(elementIndex),firstStyle=styleInputs[0],mapBasedStyleInput=firstStyle&&"style"==firstStyle.name?firstStyle:null,firstClass=classInputs[0],mapBasedClassInput=firstClass&&isClassBinding(firstClass)?firstClass:null,stylingInput=mapBasedStyleInput||mapBasedClassInput;if(stylingInput){var params=[];mapBasedClassInput?params.push(this.convertPropertyBinding(implicit,mapBasedClassInput.value,!0)):mapBasedStyleInput&&params.push(NULL_EXPR),mapBasedStyleInput&&params.push(this.convertPropertyBinding(implicit,mapBasedStyleInput.value,!0)),this.instruction.apply(this,[this._bindingCode,stylingInput.sourceSpan,Identifiers$1.elementStylingMap,indexLiteral].concat(params))}var lastInputCommand=null;if(styleInputs.length){for(i=mapBasedStyleInput?1:0;i<styleInputs.length;i++){input=styleInputs[i],params=[this.convertPropertyBinding(implicit,input.value,!0)];(sanitizationRef=resolveSanitizationFn(input,input.securityContext))&&params.push(sanitizationRef);var key=input.name,styleIndex=stylesIndexMap[key];this.instruction.apply(this,[this._bindingCode,input.sourceSpan,Identifiers$1.elementStyleProp,indexLiteral,literal(styleIndex)].concat(params))}lastInputCommand=styleInputs[styleInputs.length-1]}if(classInputs.length){for(i=mapBasedClassInput?1:0;i<classInputs.length;i++){var sanitizationRef;input=classInputs[i],params=[this.convertPropertyBinding(implicit,input.value,!0)];(sanitizationRef=resolveSanitizationFn(input,input.securityContext))&&params.push(sanitizationRef);key=input.name;var classIndex=classesIndexMap[key];this.instruction.apply(this,[this._bindingCode,input.sourceSpan,Identifiers$1.elementClassProp,indexLiteral,literal(classIndex)].concat(params))}lastInputCommand=classInputs[classInputs.length-1]}this.instruction(this._bindingCode,lastInputCommand.sourceSpan,Identifiers$1.elementStylingApply,indexLiteral)}if(allOtherInputs.forEach(function(input){if(4!==input.type){var convertedBinding=_this.convertPropertyBinding(implicit,input.value),instruction=function(type){switch(type){case 0:return Identifiers$1.elementProperty;case 1:return Identifiers$1.elementAttribute;case 2:return Identifiers$1.elementClassProp;default:return}}(input.type);if(instruction){var params=[convertedBinding],sanitizationRef=resolveSanitizationFn(input,input.securityContext);sanitizationRef&&params.push(sanitizationRef),_this.instruction.apply(_this,[_this._bindingCode,input.sourceSpan,instruction,literal(elementIndex),literal(input.name)].concat(params))}else _this._unsupported("binding type "+input.type)}else console.error("warning: animation bindings not yet supported")}),this._inI18nSection&&1==element.children.length&&element.children[0]instanceof Text$3){var text=element.children[0];this.visitSingleI18nTextChild(text,i18nMeta)}else visitAll$1(this,element.children);createSelfClosingInstruction||this.instruction(this._creationCode,element.endSourceSpan||element.sourceSpan,Identifiers$1.elementEnd),this._inI18nSection=wasInI18nSection},TemplateDefinitionBuilder.prototype.visitTemplate=function(template){var _this=this,templateIndex=this.allocateDataSlot(),elName="";1===template.children.length&&template.children[0]instanceof Element$1&&(elName=sanitizeIdentifier(template.children[0].name));var contextName=elName?this.contextName+"_"+elName:"",templateName=contextName?contextName+"_Template_"+templateIndex:"Template_"+templateIndex,templateContext="ctx"+this.level,parameters=[literal(templateIndex),variable(templateName),TYPED_NULL_EXPR],attributeNames=[],attributeMap={};if(template.attributes.forEach(function(a){attributeNames.push(asLiteral(a.name),asLiteral("")),attributeMap[a.name]=a.value}),this.directiveMatcher){var selector=createCssSelector("ng-template",attributeMap);this.directiveMatcher.match(selector,function(cssSelector,staticType){_this.directives.add(staticType)})}attributeNames.length&&parameters.push(this.constantPool.getConstLiteral(literalArr(attributeNames),!0)),this.instruction.apply(this,[this._creationCode,template.sourceSpan,Identifiers$1.containerCreate].concat(trimTrailingNulls(parameters)));var context=variable(CONTEXT_NAME);template.inputs.forEach(function(input){var convertedBinding=_this.convertPropertyBinding(context,input.value);_this.instruction(_this._bindingCode,template.sourceSpan,Identifiers$1.elementProperty,literal(templateIndex),literal(input.name),convertedBinding)});var templateFunctionExpr=new TemplateDefinitionBuilder(this.constantPool,templateContext,this._bindingScope,this.level+1,contextName,templateName,[],this.directiveMatcher,this.directives,this.pipeTypeByName,this.pipes,this._namespace).buildTemplateFunction(template.children,template.variables);this._postfixCode.push(templateFunctionExpr.toDeclStmt(templateName,null))},TemplateDefinitionBuilder.prototype.visitBoundText=function(text){var nodeIndex=this.allocateDataSlot();this.instruction(this._creationCode,text.sourceSpan,Identifiers$1.text,literal(nodeIndex)),this.instruction(this._bindingCode,text.sourceSpan,Identifiers$1.textBinding,literal(nodeIndex),this.convertPropertyBinding(variable(CONTEXT_NAME),text.value))},TemplateDefinitionBuilder.prototype.visitText=function(text){this.instruction(this._creationCode,text.sourceSpan,Identifiers$1.text,literal(this.allocateDataSlot()),literal(text.value))},TemplateDefinitionBuilder.prototype.visitSingleI18nTextChild=function(text,i18nMeta){var meta=parseI18nMeta(i18nMeta),variable$$1=this.constantPool.getTranslation(text.value,meta);this.instruction(this._creationCode,text.sourceSpan,Identifiers$1.text,literal(this.allocateDataSlot()),variable$$1)},TemplateDefinitionBuilder.prototype.allocateDataSlot=function(){return this._dataIndex++},TemplateDefinitionBuilder.prototype.bindingContext=function(){return""+this._bindingContext++},TemplateDefinitionBuilder.prototype.instruction=function(statements,span,reference){for(var params=[],_i=3;_i<arguments.length;_i++)params[_i-3]=arguments[_i];statements.push(importExpr(reference,null,span).callFn(params,span).toStmt())},TemplateDefinitionBuilder.prototype.convertPropertyBinding=function(implicit,value,skipBindFn){var _a,_b,pipesConvertedValue=value.visit(this._valueConverter);if(pipesConvertedValue instanceof Interpolation){var convertedPropertyBinding=convertPropertyBinding(this,implicit,pipesConvertedValue,this.bindingContext(),BindingForm.TrySimple,interpolate);return(_a=this._bindingCode).push.apply(_a,convertedPropertyBinding.stmts),convertedPropertyBinding.currValExpr}convertedPropertyBinding=convertPropertyBinding(this,implicit,pipesConvertedValue,this.bindingContext(),BindingForm.TrySimple,function(){return error("Unexpected interpolation")});(_b=this._bindingCode).push.apply(_b,convertedPropertyBinding.stmts);var valExpr=convertedPropertyBinding.currValExpr;return skipBindFn?valExpr:importExpr(Identifiers$1.bind).callFn([valExpr])},TemplateDefinitionBuilder}(),ValueConverter=function(_super){function ValueConverter(constantPool,allocateSlot,allocatePureFunctionSlots,definePipe){var _this=_super.call(this)||this;return _this.constantPool=constantPool,_this.allocateSlot=allocateSlot,_this.allocatePureFunctionSlots=allocatePureFunctionSlots,_this.definePipe=definePipe,_this}return __extends(ValueConverter,_super),ValueConverter.prototype.visitPipe=function(pipe,context){var slot=this.allocateSlot(),slotPseudoLocal="PIPE:"+slot,pureFunctionSlot=this.allocatePureFunctionSlots(2+pipe.args.length),target=new PropertyRead(pipe.span,new ImplicitReceiver(pipe.span),slotPseudoLocal),_a=function(args){var identifier=pipeBindingIdentifiers[args.length];return{identifier:identifier||Identifiers$1.pipeBindV,isVarLength:!identifier}}(pipe.args),identifier=_a.identifier,isVarLength=_a.isVarLength;this.definePipe(pipe.name,slotPseudoLocal,slot,importExpr(identifier));var args=[pipe.exp].concat(pipe.args),convertedArgs=isVarLength?this.visitAll([new LiteralArray(pipe.span,args)]):this.visitAll(args);return new FunctionCall(pipe.span,target,[new LiteralPrimitive(pipe.span,slot),new LiteralPrimitive(pipe.span,pureFunctionSlot)].concat(convertedArgs))},ValueConverter.prototype.visitLiteralArray=function(array,context){var _this=this;return new BuiltinFunctionCall(array.span,this.visitAll(array.expressions),function(values){var literal$$1=literalArr(values);return values.every(function(a){return a.isConstant()})?_this.constantPool.getConstLiteral(literal$$1,!0):getLiteralFactory(_this.constantPool,literal$$1,_this.allocatePureFunctionSlots)})},ValueConverter.prototype.visitLiteralMap=function(map,context){var _this=this;return new BuiltinFunctionCall(map.span,this.visitAll(map.values),function(values){var literal$$1=literalMap(values.map(function(value,index){return{key:map.keys[index].key,value:value,quoted:map.keys[index].quoted}}));return values.every(function(a){return a.isConstant()})?_this.constantPool.getConstLiteral(literal$$1,!0):getLiteralFactory(_this.constantPool,literal$$1,_this.allocatePureFunctionSlots)})},ValueConverter}(AstMemoryEfficientTransformer),pipeBindingIdentifiers=[Identifiers$1.pipeBind1,Identifiers$1.pipeBind2,Identifiers$1.pipeBind3,Identifiers$1.pipeBind4];var pureFunctionIdentifiers=[Identifiers$1.pureFunction0,Identifiers$1.pureFunction1,Identifiers$1.pureFunction2,Identifiers$1.pureFunction3,Identifiers$1.pureFunction4,Identifiers$1.pureFunction5,Identifiers$1.pureFunction6,Identifiers$1.pureFunction7,Identifiers$1.pureFunction8];function getLiteralFactory(constantPool,literal$$1,allocateSlots){var _a=constantPool.getLiteralFactory(literal$$1),literalFactory=_a.literalFactory,literalFactoryArguments=_a.literalFactoryArguments,startSlot=allocateSlots(1+literalFactoryArguments.length);literalFactoryArguments.length>0||error("Expected arguments to a literal factory function");var _b=function(args){var identifier=pureFunctionIdentifiers[args.length];return{identifier:identifier||Identifiers$1.pureFunctionV,isVarLength:!identifier}}(literalFactoryArguments),identifier=_b.identifier,isVarLength=_b.isVarLength,args=[literal(startSlot),literalFactory];return isVarLength?args.push(literalArr(literalFactoryArguments)):args.push.apply(args,literalFactoryArguments),importExpr(identifier).callFn(args)}var BindingScope=function(){function BindingScope(parent,declareLocalVarCallback){void 0===parent&&(parent=null),void 0===declareLocalVarCallback&&(declareLocalVarCallback=noop),this.parent=parent,this.declareLocalVarCallback=declareLocalVarCallback,this.map=new Map,this.referenceNameIndex=0}return Object.defineProperty(BindingScope,"ROOT_SCOPE",{get:function(){return BindingScope._ROOT_SCOPE||(BindingScope._ROOT_SCOPE=(new BindingScope).set("$event",variable("$event"))),BindingScope._ROOT_SCOPE},enumerable:!0,configurable:!0}),BindingScope.prototype.get=function(name){for(var current=this;current;){var value=current.map.get(name);if(null!=value)return current!==this&&(value={lhs:value.lhs,rhs:value.rhs,declared:!1},this.map.set(name,value)),value.rhs&&!value.declared&&(this.declareLocalVarCallback(value.lhs,value.rhs),value.declared=!0),value.lhs;current=current.parent}return null},BindingScope.prototype.set=function(name,lhs,rhs){return!this.map.has(name)||error("The name "+name+" is already defined in scope to be "+this.map.get(name)),this.map.set(name,{lhs:lhs,rhs:rhs,declared:!1}),this},BindingScope.prototype.getLocal=function(name){return this.get(name)},BindingScope.prototype.nestedScope=function(declareCallback){return new BindingScope(this,declareCallback)},BindingScope.prototype.freshReferenceName=function(){for(var current=this;current.parent;)current=current.parent;return"_r"+current.referenceNameIndex++},BindingScope}();function createCssSelector(tag,attributes){var cssSelector=new CssSelector;return cssSelector.setElement(tag),Object.getOwnPropertyNames(attributes).forEach(function(name){var value=attributes[name];(cssSelector.addAttribute(name,value),"class"===name.toLowerCase())&&value.trim().split(/\s+/g).forEach(function(className){return cssSelector.addClassName(className)})}),cssSelector}function parseI18nMeta(i18n){var _a,_b,meaning,description,id;if(i18n){var idIndex=i18n.indexOf(ID_SEPARATOR$1),descIndex=i18n.indexOf(MEANING_SEPARATOR$1),meaningAndDesc=void 0;meaningAndDesc=(_a=idIndex>-1?[i18n.slice(0,idIndex),i18n.slice(idIndex+2)]:[i18n,""])[0],id=_a[1],meaning=(_b=descIndex>-1?[meaningAndDesc.slice(0,descIndex),meaningAndDesc.slice(descIndex+1)]:["",meaningAndDesc])[0],description=_b[1]}return{description:description,id:id,meaning:meaning}}function interpolate(args){switch((args=args.slice(1)).length){case 3:return importExpr(Identifiers$1.interpolation1).callFn(args);case 5:return importExpr(Identifiers$1.interpolation2).callFn(args);case 7:return importExpr(Identifiers$1.interpolation3).callFn(args);case 9:return importExpr(Identifiers$1.interpolation4).callFn(args);case 11:return importExpr(Identifiers$1.interpolation5).callFn(args);case 13:return importExpr(Identifiers$1.interpolation6).callFn(args);case 15:return importExpr(Identifiers$1.interpolation7).callFn(args);case 17:return importExpr(Identifiers$1.interpolation8).callFn(args)}return args.length>=19&&args.length%2==1||error("Invalid interpolation argument length "+args.length),importExpr(Identifiers$1.interpolationV).callFn([literalArr(args)])}function makeBindingParser(){return new BindingParser(new Parser(new Lexer),DEFAULT_INTERPOLATION_CONFIG,new DomElementSchemaRegistry,null,[])}function isClassBinding(input){return"className"==input.name||"class"==input.name}function resolveSanitizationFn(input,context){switch(context){case SecurityContext.HTML:return importExpr(Identifiers$1.sanitizeHtml);case SecurityContext.SCRIPT:return importExpr(Identifiers$1.sanitizeScript);case SecurityContext.STYLE:return 1===input.type?importExpr(Identifiers$1.sanitizeStyle):null;case SecurityContext.URL:return importExpr(Identifiers$1.sanitizeUrl);case SecurityContext.RESOURCE_URL:return importExpr(Identifiers$1.sanitizeResourceUrl);default:return null}}function baseDirectiveFields(meta,constantPool,bindingParser){var definitionMap=new DefinitionMap;definitionMap.set("type",meta.type),definitionMap.set("selectors",asLiteral(parseSelectorToR3Selector(meta.selector))),definitionMap.set("factory",compileFactoryFunction({name:meta.name,fnOrClass:meta.type,deps:meta.deps,useNew:!0,injectFn:Identifiers$1.directiveInject})),definitionMap.set("contentQueries",function(meta,constantPool){if(meta.queries.length){var statements=meta.queries.map(function(query){var queryDefinition=createQueryDefinition(query,constantPool,null);return importExpr(Identifiers$1.registerContentQuery).callFn([queryDefinition]).toStmt()}),typeName=meta.name;return fn([],statements,INFERRED_TYPE,null,typeName?typeName+"_ContentQueries":null)}return null}(meta,constantPool)),definitionMap.set("contentQueriesRefresh",function(meta){if(meta.queries.length>0){var statements_1=[],typeName=meta.name,parameters=[new FnParam("dirIndex",NUMBER_TYPE),new FnParam("queryStartIndex",NUMBER_TYPE)],directiveInstanceVar_1=variable("instance"),temporary_1=temporaryAllocator(statements_1,TEMPORARY_NAME);return statements_1.push(directiveInstanceVar_1.set(importExpr(Identifiers$1.loadDirective).callFn([variable("dirIndex")])).toDeclStmt(INFERRED_TYPE,[StmtModifier.Final])),meta.queries.forEach(function(query,idx){var loadQLArg=variable("queryStartIndex"),getQueryList=importExpr(Identifiers$1.loadQueryList).callFn([idx>0?loadQLArg.plus(literal(idx)):loadQLArg]),assignToTemporary=temporary_1().set(getQueryList),callQueryRefresh=importExpr(Identifiers$1.queryRefresh).callFn([assignToTemporary]),updateDirective=directiveInstanceVar_1.prop(query.propertyName).set(query.first?temporary_1().prop("first"):temporary_1()),refreshQueryAndUpdateDirective=callQueryRefresh.and(updateDirective);statements_1.push(refreshQueryAndUpdateDirective.toStmt())}),fn(parameters,statements_1,INFERRED_TYPE,null,typeName?typeName+"_ContentQueriesRefresh":null)}return null}(meta)),definitionMap.set("hostBindings",function(meta,bindingParser){var statements=[],hostBindingSourceSpan=meta.typeSourceSpan,directiveSummary=function(meta){return{hostAttributes:meta.host.attributes,hostListeners:meta.host.listeners,hostProperties:meta.host.properties}}(meta),bindings=bindingParser.createBoundHostProperties(directiveSummary,hostBindingSourceSpan),bindingContext=importExpr(Identifiers$1.loadDirective).callFn([variable("dirIndex")]);if(bindings)for(var _i=0,bindings_1=bindings;_i<bindings_1.length;_i++){var binding=bindings_1[_i],bindingExpr=convertPropertyBinding(null,bindingContext,binding.expression,"b",BindingForm.TrySimple,function(){return error("Unexpected interpolation")});statements.push.apply(statements,bindingExpr.stmts),statements.push(importExpr(Identifiers$1.elementProperty).callFn([variable("elIndex"),literal(binding.name),importExpr(Identifiers$1.bind).callFn([bindingExpr.currValExpr])]).toStmt())}var eventBindings=bindingParser.createDirectiveHostEventAsts(directiveSummary,hostBindingSourceSpan);if(eventBindings)for(var _a=0,eventBindings_1=eventBindings;_a<eventBindings_1.length;_a++){var binding=eventBindings_1[_a],bindingExpr=convertActionBinding(null,bindingContext,binding.handler,"b",function(){return error("Unexpected interpolation")}),bindingName=binding.name&&sanitizeIdentifier(binding.name),typeName=meta.name,functionName=typeName&&bindingName?typeName+"_"+bindingName+"_HostBindingHandler":null,handler=fn([new FnParam("$event",DYNAMIC_TYPE)],bindingExpr.stmts.concat([new ReturnStatement(bindingExpr.allowDefault)]),INFERRED_TYPE,null,functionName);statements.push(importExpr(Identifiers$1.listener).callFn([literal(binding.name),handler]).toStmt())}if(statements.length>0){var typeName=meta.name;return fn([new FnParam("dirIndex",NUMBER_TYPE),new FnParam("elIndex",NUMBER_TYPE)],statements,INFERRED_TYPE,null,typeName?typeName+"_HostBindings":null)}return null}(meta,bindingParser)),definitionMap.set("attributes",function(meta){for(var values=[],attributes=meta.host.attributes,_i=0,_a=Object.getOwnPropertyNames(attributes);_i<_a.length;_i++){var key=_a[_i],value=attributes[key];values.push(literal(key),literal(value))}if(values.length>0)return literalArr(values);return null}(meta)),definitionMap.set("inputs",conditionallyCreateMapObjectLiteral(meta.inputs)),definitionMap.set("outputs",conditionallyCreateMapObjectLiteral(meta.outputs));var features=[];return meta.usesInheritance&&features.push(importExpr(Identifiers$1.InheritDefinitionFeature)),meta.lifecycle.usesOnChanges&&features.push(importExpr(Identifiers$1.NgOnChangesFeature)),features.length&&definitionMap.set("features",literalArr(features)),definitionMap}function compileDirectiveFromMetadata(meta,constantPool,bindingParser){var definitionMap=baseDirectiveFields(meta,constantPool,bindingParser),expression=importExpr(Identifiers$1.defineDirective).callFn([definitionMap.toLiteralMap()]),selectorForType=(meta.selector||"").replace(/\n/g,"");return{expression:expression,type:new ExpressionType(importExpr(Identifiers$1.DirectiveDef,[typeWithParameters(meta.type,meta.typeArgumentCount),new ExpressionType(literal(selectorForType))]))}}function compileComponentFromMetadata(meta,constantPool,bindingParser){var definitionMap=baseDirectiveFields(meta,constantPool,bindingParser),selector=meta.selector&&CssSelector.parse(meta.selector),firstSelector=selector&&selector[0];if(firstSelector){var selectorAttributes=firstSelector.getAttrs();selectorAttributes.length&&definitionMap.set("attrs",constantPool.getConstLiteral(literalArr(selectorAttributes.map(function(value){return literal(null!=value?value:void 0)})),!0))}var directiveMatcher=null;if(meta.directives.size){var matcher_1=new SelectorMatcher;meta.directives.forEach(function(expression,selector){matcher_1.addSelectables(CssSelector.parse(selector),expression)}),directiveMatcher=matcher_1}meta.viewQueries.length&&definitionMap.set("viewQuery",function(meta,constantPool){for(var createStatements=[],updateStatements=[],tempAllocator=temporaryAllocator(updateStatements,TEMPORARY_NAME),i=0;i<meta.viewQueries.length;i++){var query=meta.viewQueries[i],queryDefinition=createQueryDefinition(query,constantPool,i);createStatements.push(queryDefinition.toStmt());var temporary=tempAllocator(),getQueryList=importExpr(Identifiers$1.load).callFn([literal(i)]),refresh=importExpr(Identifiers$1.queryRefresh).callFn([temporary.set(getQueryList)]),updateDirective=variable(CONTEXT_NAME).prop(query.propertyName).set(query.first?temporary.prop("first"):temporary);updateStatements.push(refresh.and(updateDirective).toStmt())}var viewQueryFnName=meta.name?meta.name+"_Query":null;return fn([new FnParam(RENDER_FLAGS,NUMBER_TYPE),new FnParam(CONTEXT_NAME,null)],[renderFlagCheckIfStmt(1,createStatements),renderFlagCheckIfStmt(2,updateStatements)],INFERRED_TYPE,null,viewQueryFnName)}(meta,constantPool));var templateTypeName=meta.name,templateName=templateTypeName?templateTypeName+"_Template":null,directivesUsed=new Set,pipesUsed=new Set,template=meta.template,templateFunctionExpression=new TemplateDefinitionBuilder(constantPool,CONTEXT_NAME,BindingScope.ROOT_SCOPE,0,templateTypeName,templateName,meta.viewQueries,directiveMatcher,directivesUsed,meta.pipes,pipesUsed,Identifiers$1.namespaceHTML).buildTemplateFunction(template.nodes,[],template.hasNgContent,template.ngContentSelectors);definitionMap.set("template",templateFunctionExpression),directivesUsed.size&&definitionMap.set("directives",literalArr(Array.from(directivesUsed))),pipesUsed.size&&definitionMap.set("pipes",literalArr(Array.from(pipesUsed)));var selectorForType=(meta.selector||"").replace(/\n/g,"");return{expression:importExpr(Identifiers$1.defineComponent).callFn([definitionMap.toLiteralMap()]),type:new ExpressionType(importExpr(Identifiers$1.ComponentDef,[typeWithParameters(meta.type,meta.typeArgumentCount),new ExpressionType(literal(selectorForType))]))}}function directiveMetadataFromGlobalMetadata(directive,outputCtx,reflector){var summary=directive.toSummary(),name=identifierName(directive.type);return name||error("Cannot resolver the name of "+directive.type),{name:name,type:outputCtx.importExpr(directive.type.reference),typeArgumentCount:0,typeSourceSpan:typeSourceSpan(directive.isComponent?"Component":"Directive",directive.type),selector:directive.selector,deps:dependenciesFromGlobalMetadata(directive.type,outputCtx,reflector),queries:queriesFromGlobalMetadata(directive.queries,outputCtx),lifecycle:{usesOnChanges:directive.type.lifecycleHooks.some(function(lifecycle){return lifecycle==LifecycleHooks.OnChanges})},host:{attributes:directive.hostAttributes,listeners:summary.hostListeners,properties:summary.hostProperties},inputs:directive.inputs,outputs:directive.outputs,usesInheritance:!1}}function queriesFromGlobalMetadata(queries,outputCtx){return queries.map(function(query){var read=null;return query.read&&query.read.identifier&&(read=outputCtx.importExpr(query.read.identifier.reference)),{propertyName:query.propertyName,first:query.first,predicate:function(selectors,outputCtx){if(selectors.length>1||1==selectors.length&&selectors[0].value){var selectorStrings=selectors.map(function(value){return value.value});return selectorStrings.some(function(value){return!value})&&error("Found a type among the string selectors expected"),outputCtx.constantPool.getConstLiteral(literalArr(selectorStrings.map(function(value){return literal(value)})))}if(1==selectors.length){var first=selectors[0];if(first.identifier)return outputCtx.importExpr(first.identifier.reference)}return error("Unexpected query form"),NULL_EXPR}(query.selectors,outputCtx),descendants:query.descendants,read:read}})}function createQueryDefinition(query,constantPool,idx){var predicate=function(query,constantPool){return Array.isArray(query.predicate)?constantPool.getConstLiteral(literalArr(query.predicate.map(function(selector){return literal(selector)}))):query.predicate}(query,constantPool),parameters=[literal(idx,INFERRED_TYPE),predicate,literal(query.descendants)];return query.read&&parameters.push(query.read),importExpr(Identifiers$1.query).callFn(parameters)}function typeMapToExpressionMap(map,outputCtx){var entries=Array.from(map).map(function(_a){var key=_a[0],type=_a[1];return[key,outputCtx.importExpr(type)]});return new Map(entries)}var HOST_REG_EXP$1=/^(?:(?:\[([^\]]+)\])|(?:\(([^\)]+)\)))|(\@[-\w]+)$/;
/**
 * @license
 * Copyright Google Inc. All Rights Reserved.
 *
 ...
 * found in the LICENSE file at https://angular.io/license
 */
function(meta){var factory=NULL_EXPR;function makeFn(ret){return fn([],[new ReturnStatement(ret)],void 0,void 0,meta.name+"_Factory")}if(void 0!==meta.useClass||void 0!==meta.useFactory)if(void 0!==meta.deps){var fnOrClass=meta.useClass||meta.useFactory,useNew=void 0!==meta.useClass;factory=compileFactoryFunction({name:meta.name,fnOrClass:fnOrClass,useNew:useNew,injectFn:Identifiers.inject,deps:meta.deps})}else if(void 0!==meta.useClass){if(meta.useClass.isEquivalent(meta.type))throw new Error("useClass is the same as the type, but no deps specified, which is invalid.");factory=makeFn(new ReadPropExpr(new ReadPropExpr(meta.useClass,"ngInjectableDef"),"factory").callFn([]))}else{if(void 0===meta.useFactory)throw new Error("Reached unreachable block in injectable compiler.");factory=meta.useFactory.callFn([])}else if(void 0!==meta.useValue)factory=makeFn(meta.useValue);else if(void 0!==meta.useExisting)factory=makeFn(importExpr(Identifiers.inject).callFn([meta.useExisting]));else{if(void 0===meta.deps)throw new Error("Type compilation of an injectable requires dependencies.");factory=compileFactoryFunction({name:meta.name,fnOrClass:meta.type,useNew:!0,injectFn:Identifiers.inject,deps:meta.deps})}var token=meta.type,providedIn=meta.providedIn;return{expression:importExpr(Identifiers.defineInjectable).callFn([mapToMapExpression({token:token,factory:factory,providedIn:providedIn})]),type:new ExpressionType(importExpr(Identifiers.InjectableDef,[new ExpressionType(meta.type)]))}},Object.defineProperty(exports,"__esModule",{value:!0})});